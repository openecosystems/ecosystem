    ...
    SlidingPanesSettingTab.prototype.display = function () {
        ...
        new obsidian.Setting(containerEl)
            ...
            .addToggle(function (toggle) {
                return toggle.setValue(!_this.plugin.settings.disabled).onChange(function (value) {
        ...
        new obsidian.Setting(containerEl)
            ...
            .addToggle(function (toggle) {
                return toggle.setValue(_this.plugin.settings.smoothAnimation).onChange(function (value) {
        ...
        new obsidian.Setting(containerEl)
            ...
            .addToggle(function (toggle) {
                return toggle.setValue(_this.plugin.settings.leafAutoWidth).onChange(function (value) {
        ...
        new obsidian.Setting(containerEl)
            ...
            .addToggle(function (toggle) {
                return toggle.setValue(_this.plugin.settings.rotateHeaders).onChange(function (value) {
        ...
        new obsidian.Setting(containerEl)
            ...
            .addToggle(function (toggle) {
                return toggle.setValue(_this.plugin.settings.headerAlt).onChange(function (value) {
        ...
        new obsidian.Setting(containerEl)
            ...
            .addToggle(function (toggle) {
                return toggle.setValue(_this.plugin.settings.stackingEnabled).onChange(function (value) {
...
var SlidingPanesCommands = /** @class */ (function () {
    ...
    SlidingPanesCommands.prototype.addCommands = function () {
        ...
        this.addToggleSettingCommand(
            'toggle-sliding-panes-smooth-animation',
...
var SlidingPanesPlugin = /** @class */ (function (_super) {
    ...
    function SlidingPanesPlugin() {
        ...
        _this.enable = function () {
            ...
            _this.app.workspace.layoutReady
                ? _this.reallyEnable()
                : _this.app.workspace.on('layout-ready', _this.reallyEnable);
        };
        ...
        _this.clearLeaf = function (leaf) {
            ...
            if (iconText.includes('(')) {
                iconEl.setAttribute(
                    'aria-label',
                    iconText.substring(iconText.lastIndexOf('(') + 1, iconText.lastIndexOf(')'))
                );
            }
        };
        ...
        _this.updateStyle = function () {
            ...
            if (!el) throw 'plugin-sliding-panes element not found!';
                ...
                if (!_this.settings.leafAutoWidth) {
                    el.innerText +=
                        'body.plugin-sliding-panes .mod-root>.workspace-leaf{width:' +
                        (_this.settings.leafWidth + _this.settings.headerWidth) +
                        'px;}';
                }
            }
        ...
        _this.recalculateLeaves = function () {
            ...
            rootLeaves.forEach(function (leaf, i) {
                ...
                if (_this.settings.leafAutoWidth) {
                    containerEl.style.width =
                        rootContainerEl.clientWidth - (leafCount - 1) * _this.settings.headerWidth + 'px';
                } else {
                    containerEl.style.width = null;
                }
                if (oldWidth == containerEl.clientWidth) widthChange = true;
                containerEl.style.left = _this.settings.stackingEnabled ? i * _this.settings.headerWidth + 'px' : null;
            ...
            if (widthChange) _this.focusActiveLeaf(!_this.settings.leafAutoWidth);
        };
        ...
        _this.handleDelete = function (file) {
            ...
            leavesToDetach.forEach(function (leaf) {
                return leaf.detach();
            });
        };
            ...
            if (_this.rootSplitAny.direction === 'vertical') {
                ...
                var mouseup_1 = function () {
                    ...
                    if (_this.settings.stackingEnabled) {
                        ...
                        var rootLeaves = _this.rootLeaves;
                        var leafCount = rootLeaves.length;
                        var leafIndex = rootLeaves.findIndex(function (l) {
                            return l == leaf;
                        });
                        leaf.containerEl.style.right =
                            (leafCount - leafIndex - 1) * _this.settings.headerWidth -
                            leaf.containerEl.clientWidth +
                            'px';
                    }
    ...
    Object.defineProperty(SlidingPanesPlugin.prototype, 'rootContainerEl', {
        get: function () {
            return this.app.workspace.rootSplit.containerEl;
        },
        enumerable: false,
        configurable: true,
    });
    ...
    SlidingPanesPlugin.prototype.focusActiveLeaf = function (animated) {
        ...
        while (
            activeLeaf != null &&
            activeLeaf.parentSplit != null &&
            activeLeaf.parentSplit != this.app.workspace.rootSplit
        ) {
        ...
        if (activeLeaf != null && this.rootSplit) {
            ...
            var headersToRightWidth = this.settings.stackingEnabled
                ? (leafCount - this.activeLeafIndex - 1) * this.settings.headerWidth
                : 0;
            ...
            // it's too far right
                ...
                rootContainerEl.scrollLeft + rootContainerEl.clientWidth <
                position_1 + activeLeaf.containerEl.clientWidth + headersToRightWidth
            ) {
                // scroll the right side of the pane into view
                rootContainerEl.scrollTo({
                    left:
                        position_1 +
                        activeLeaf.containerEl.clientWidth +
                        headersToRightWidth -
                        rootContainerEl.clientWidth,
                    top: 0,
                    behavior: behavior,
                });
            }
