    ...
    q = (i, e, t) => {
        if ((e && typeof e == 'object') || typeof e == 'function')
            for (let n of $(e))
                !A.call(i, n) &&
                    n !== 'default' &&
                    m(i, n, { get: () => e[n], enumerable: !(t = F(e, n)) || t.enumerable });
        return i;
    },
    h = (i) =>
        q(
...
var c = { None: '', TOC: '[TOC]', _TOC_: '__TOC__', AzureWiki: '_TOC_', DevonThink: '{{toc}}', TheBrain: '[/toc/]' };
var P = {
        style: 'bullet',
        min_depth: 2,
        max_depth: 6,
...
var v = class {
    ...
    get href() {
        return this.isLink ? `#${this.parseMarkdownLink(this.rawHeading).split('|').join(' ')}` : null;
    }
    get markdownHref() {
...
function T(i, e) {
    ...
    let { headings: t } = i,
        n = t.filter((a) => !!a && a.level >= e.min_depth && a.level <= e.max_depth);
    if (!n.length) return '';
...
function G(i, e, t) {
    ...
    return !t.varied_style || i.level === e ? n : t.style === 'number' ? '-' : '1.';
}
function U(i, e) {
    let t = i[0].level,
        n = [];
    ...
    for (let a = 0; a < i.length; a++) {
        ...
        e.allow_inconsistent_headings && (l.length - s > 1 && (l = new Array(s + 1)), (s = l.length));
        let g = l.fill('	').join('');
...
var S = class extends C.MarkdownRenderChild {
    ...
    onload() {
        return r(this, null, function* () {
            yield this.render(),
                this.registerEvent(this.app.metadataCache.on('dynamic-toc:settings', this.onSettingsChangeHandler)),
    ...
    render(e) {
        return r(this, null, function* () {
            ...
            let t = T(this.app.metadataCache.getCache(this.filePath), e || this.config);
            yield C.MarkdownRenderer.renderMarkdown(t, this.container, this.filePath, this);
        });
    }
};
                    ...
                    n
                        ...
                        .onChange((s) =>
                            r(this, null, function* () {
                                (this.plugin.settings.style = s), yield this.plugin.saveSettings();
                            })
                        )
                ),
            new o.Setting(e)
                ...
                .addToggle((n) =>
                    n.setValue(this.plugin.settings.varied_style).onChange((s) =>
                        r(this, null, function* () {
                            (this.plugin.settings.varied_style = s), yield this.plugin.saveSettings();
                        })
                    )
                ),
            new o.Setting(e)
                .setName('Delimiter')
                .setDesc('Only used when list style is inline. The delimiter between the list items')
                .addText((n) =>
                    n
                        .setPlaceholder('e.g. -, *, ~')
                        ...
                        .onChange((s) =>
                            r(this, null, function* () {
                                (this.plugin.settings.delimiter = s), this.plugin.saveSettings();
                            })
                        )
                ),
            new o.Setting(e)
                        ...
                        .onChange((s) =>
                            r(this, null, function* () {
                                s > this.plugin.settings.max_depth
                                    ...
                                    : ((this.plugin.settings.min_depth = s), yield this.plugin.saveSettings());
                            })
                        )
                ),
            new o.Setting(e)
                        ...
                        .onChange((s) =>
                            r(this, null, function* () {
                                s < this.plugin.settings.min_depth
                                    ...
                                    : ((this.plugin.settings.max_depth = s), yield this.plugin.saveSettings());
                            })
                        )
                ),
            new o.Setting(e)
        ...
        let t = new o.Setting(e)
            ...
            .addDropdown((n) =>
                n
                    ...
                    .onChange((s) =>
                        r(this, null, function* () {
                            (this.plugin.settings.externalStyle = s), yield this.plugin.saveSettings();
                        })
                    )
            );
        new o.Setting(e)
            ...
            new o.Setting(e)
                ...
                .addToggle((n) =>
                    n.setValue(this.plugin.settings.allow_inconsistent_headings).onChange((s) =>
                        r(this, null, function* () {
                            (this.plugin.settings.allow_inconsistent_headings = s), yield this.plugin.saveSettings();
                        })
                    )
                );
    }
...
var w = class extends b.MarkdownRenderChild {
    ...
    render() {
        return r(this, null, function* () {
            ...
            n && this.containerEl.removeChild(n), this.match.parentNode.appendChild(t);
        });
    }
};
var K = h(require('obsidian')),
    ...
    x = class extends K.FuzzySuggestModal {
        constructor(e, t) {
            super(e);
            (this.app = e), (this.plugin = t), this.setPlaceholder('Type name of table of contents type...');
        }
        getItems() {
            ...
            r(this, null, function* () {
                yield this.loadSettings(),
                    ...
                    this.registerMarkdownPostProcessor((e, t) => {
                        let n = this.settings.supportAllMatchers === !0 ? I : [this.settings.externalStyle];
                        for (let s of n) {
