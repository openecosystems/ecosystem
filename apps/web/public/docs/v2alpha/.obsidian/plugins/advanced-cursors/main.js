...
var utils = createCommonjsModule(function (module, exports) {
    Object.defineProperty(exports, '__esModule', { value: true });
    exports.waitForResolvedLinks =
        exports.resolvedLinksComplete =
        exports.addRenderedMarkdownButton =
        exports.RenderedMarkdownModal =
        exports.saveViewSide =
        exports.openView =
        exports.linkedQ =
        exports.openOrSwitch =
        exports.stripMD =
        exports.addMD =
        exports.createNewMDNote =
        exports.hoverPreview =
        exports.isInVault =
        exports.getSelectionFromCurrFile =
        exports.getSelectionFromEditor =
        exports.copy =
        exports.getAvailablePathForAttachments =
        exports.base64ToArrayBuffer =
        exports.addFeatherIcon =
        exports.addAllFeatherIcons =
        exports.wait =
            void 0;
    /**
    ...
    async function copy(
        content,
        success = () => new obsidian_1__default['default'].Notice('Copied to clipboard'),
        failure = (reason) => {
     ...
     * @returns boolean
     */
    const isInVault = (app, noteName, sourcePath = '') =>
    ...
    async function createNewMDNote(app, newName, currFilePath = '') {
        ...
        const newFilePath = (0, obsidian_1__default['default'].normalizePath)(
    ...
    async function openView(app, viewType, viewClass, side = 'right') {
        ...
        leaf = leaf ?? side === 'right' ? app.workspace.getRightLeaf(false) : app.workspace.getLeftLeaf(false);
        leaf.setViewState({
            type: viewType,
            active: true,
        });
...
var dist = createCommonjsModule(function (module, exports) {
    ...
    Object.defineProperty(exports, 'addAllFeatherIcons', {
        enumerable: true,
        get: function () {
            return utils.addAllFeatherIcons;
        },
    });
    Object.defineProperty(exports, 'addFeatherIcon', {
        enumerable: true,
        get: function () {
            return utils.addFeatherIcon;
        },
    });
    Object.defineProperty(exports, 'base64ToArrayBuffer', {
        enumerable: true,
        get: function () {
            return utils.base64ToArrayBuffer;
        },
    });
    Object.defineProperty(exports, 'getAvailablePathForAttachments', {
        enumerable: true,
        get: function () {
            return utils.getAvailablePathForAttachments;
        },
    });
    ...
    Object.defineProperty(exports, 'getSelectionFromCurrFile', {
        enumerable: true,
        get: function () {
            return utils.getSelectionFromCurrFile;
        },
    });
    Object.defineProperty(exports, 'getSelectionFromEditor', {
        enumerable: true,
        get: function () {
            return utils.getSelectionFromEditor;
        },
    });
    Object.defineProperty(exports, 'hoverPreview', {
        enumerable: true,
        get: function () {
            return utils.hoverPreview;
        },
    });
    Object.defineProperty(exports, 'isInVault', {
        enumerable: true,
        get: function () {
            return utils.isInVault;
        },
    });
    Object.defineProperty(exports, 'createNewMDNote', {
        enumerable: true,
        get: function () {
            return utils.createNewMDNote;
        },
    });
    Object.defineProperty(exports, 'openOrSwitch', {
        enumerable: true,
        get: function () {
            return utils.openOrSwitch;
        },
    });
    Object.defineProperty(exports, 'linkedQ', {
        enumerable: true,
        get: function () {
            return utils.linkedQ;
        },
    });
    Object.defineProperty(exports, 'addRenderedMarkdownButton', {
        enumerable: true,
        get: function () {
            return utils.addRenderedMarkdownButton;
        },
    });
    Object.defineProperty(exports, 'RenderedMarkdownModal', {
        enumerable: true,
        get: function () {
            return utils.RenderedMarkdownModal;
        },
    });
    Object.defineProperty(exports, 'openView', {
        enumerable: true,
        get: function () {
            return utils.openView;
        },
    });
    Object.defineProperty(exports, 'saveViewSide', {
        enumerable: true,
        get: function () {
            return utils.saveViewSide;
        },
    });
    Object.defineProperty(exports, 'addMD', {
        enumerable: true,
        get: function () {
            return utils.addMD;
        },
    });
    Object.defineProperty(exports, 'stripMD', {
        enumerable: true,
        get: function () {
            return utils.stripMD;
        },
    });
    Object.defineProperty(exports, 'resolvedLinksComplete', {
        enumerable: true,
        get: function () {
            return utils.resolvedLinksComplete;
        },
    });
    Object.defineProperty(exports, 'waitForResolvedLinks', {
        enumerable: true,
        get: function () {
            return utils.waitForResolvedLinks;
        },
    });
});
...
function create_each_block(ctx) {
    ...
    return {
        ...
        p(new_ctx, dirty) {
            ...
            if (dirty & /*plugin*/ 1 && t4_value !== (t4_value = displayRegex(/*q*/ ctx[15]) + ''))
...
function create_fragment(ctx) {
    ...
    return {
        ...
        p(ctx, [dirty]) {
            if (
                dirty & /*existingQ*/ 2 &&
                input0_value_value !== (input0_value_value = /*existingQ*/ ctx[1].name) &&
            ...
            if (
                dirty & /*existingQ*/ 2 &&
                input1_value_value !== (input1_value_value = /*existingQ*/ ctx[1].query) &&
            ...
            if (
                dirty & /*existingQ*/ 2 &&
                input2_value_value !== (input2_value_value = /*existingQ*/ ctx[1].flags) &&
            ...
            if (
                dirty & /*existingQ*/ 2 &&
                input3_checked_value !== (input3_checked_value = /*existingQ*/ ctx[1].regexQ)
            ) {
                input3.checked = input3_checked_value;
            }

            if (dirty & /*i*/ 1 && t6_value !== (t6_value = /*i*/ (ctx[0] === -1 ? 'Submit' : 'Edit') + ''))
...
class ACSettingTab extends obsidian_1.PluginSettingTab {
    ...
    display() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            new obsidian_1.Setting(containerEl).setName('Open Saved Query View on Load').addToggle((toggle) => {
                toggle.setValue(plugin.settings.openViewOnload).onChange((value) =>
                    __awaiter(this, void 0, void 0, function* () {
            ...
            new obsidian_1.Setting(containerEl)
                ...
                .addToggle((toggle) => {
                    toggle.setValue(plugin.settings.showFunctionNotifications).onChange((value) =>
                        __awaiter(this, void 0, void 0, function* () {
            ...
            // SECTION Changelog
            dist.addRenderedMarkdownButton(
                this.app,
                plugin,
                containerEl,
...
class ACPlugin extends obsidian_1.Plugin {
    ...
    setSels(appendQ, ed, ...newSels) {
        if (appendQ) {
            ...
            const reconSelections = this.reconstructSels([...currSelections, ...newSels]);
    ...
    clearOldSetNewMSpan(ed, ...newSels) {
        ...
        lines.forEach((l) => {
            var _a;
            (_a = l === null || l === void 0 ? void 0 : l.markedSpans) === null || _a === void 0
                ? void 0
                : _a.forEach((mSpan) => mSpan.marker.clear());
        });
        // Set new
    ...
    getToSelect(ed) {
        ...
        if (!(anchor.line === head.line && anchor.ch === head.ch)) {
            toSelect =
                ed.posToOffset(anchor) < ed.posToOffset(head) ? ed.getRange(anchor, head) : ed.getRange(head, anchor);
        ...
        try {
            ...
            if ((_a = ed.cm) === null || _a === void 0 ? void 0 : _a.findWordAt) {
                ...
                if (word !== null) {
                    const { from, to } =
                        (_c = ed.cm) === null || _c === void 0
                            ? void 0
                            : _c.viewState.state.wordAt(ed.posToOffset(cursor));
    ...
    isSelected(ed, selection) {
        const [offA, offH] = [ed.posToOffset(selection.anchor), ed.posToOffset(selection.head)];
        const matchingSels = ed
            .listSelections()
            .filter((sel) => ed.posToOffset(sel.anchor) === offA && ed.posToOffset(sel.head) === offH);
        return !!matchingSels.length;
    }
    nextNotSelected(ed, matches, fromOffset, mode) {
        var _a, _b;
        if (mode === 'Next') {
            return (_a = matches.find((m) => m.index > fromOffset)) !== null && _a !== void 0
                ? _a
                : matches.find((m) => {
            ...
            return (_b = matches.filter((m) => m.index < fromOffset).last()) !== null && _b !== void 0
                ? _b
                : matches
                      .filter((m) => {
                          const sel = this.matchToSel(ed, m);
    ...
    selectInstance(ed, appendQ = false, mode, existingQ) {
        ...
        if (mode === 'All') {
            ...
            this.settings.showFunctionNotifications && new obsidian_1.Notice(`${matches.length} matches found.`);
            return;
        }
        let latestSel = mode === 'Next' ? ed.listSelections().last() : ed.listSelections().first();
        ...
        toSelect =
            (_a = match === null || match === void 0 ? void 0 : match[0]) !== null && _a !== void 0 ? _a : toSelect;
