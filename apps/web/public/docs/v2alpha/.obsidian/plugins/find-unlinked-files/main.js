...
var DeleteFilesModal = /** @class */ (function (_super) {
    ...
    DeleteFilesModal.prototype.onOpen = function () {
        ...
        contentEl.createEl('button', { text: 'Cancel' }).addEventListener('click', function () {
            return _this.close();
        });
...
var SettingsTab = /** @class */ (function (_super) {
    ...
    SettingsTab.prototype.display = function () {
        ...
        new obsidian.Setting(containerEl)
            ...
            .setDesc(
                'Enable to ignore files in the given directories. Disable to only include files in the given directories'
            )
            .addToggle(function (cb) {
                return cb.setValue(_this.plugin.settings.ignoreDirectories).onChange(function (value) {
                ...
                return cb
                    ...
                    .onChange(function (value) {
                        var paths = value
                            ...
                            .split('\n')
                            .map(function (value) {
                                return _this.formatPath(value, true);
                            });
                ...
                return cb
                    ...
                    .onChange(function (value) {
                        var paths = value
                            ...
                            .split('\n')
                            .map(function (value) {
                                return _this.formatPath(value, false);
                            });
        ...
        new obsidian.Setting(containerEl)
            ...
            .setDesc(
                'Ignore files, which contain the given file as link. Add each file path in a new line (with file extension!). Set it to `*` to ignore files with links.'
            )
            .addTextArea(function (cb) {
                return cb
                    .setPlaceholder('Directory/file.md')
        ...
        new obsidian.Setting(containerEl)
            ...
            .setDesc(
                'Enable to ignore files with the given filetypes. Disable to only include files with the given filetypes'
            )
            .addToggle(function (cb) {
                return cb.setValue(_this.plugin.settings.ignoreFileTypes).onChange(function (value) {
        ...
        new obsidian.Setting(containerEl)
            .setName('Tags to ignore.')
            .setDesc(
                'Ignore links in files, which contain the given tag. Add each tag separated by comma (without `#`)'
            )
            .addTextArea(function (cb) {
                return cb
                    .setPlaceholder('todo,unfinished')
...
var Utils = /** @class */ (function () {
    ...
    Utils.prototype.hasLinksToIgnore = function () {
        ...
        var _a, _b;
        if (
            (((_a = this.fileCache) === null || _a === void 0 ? void 0 : _a.embeds) != null ||
                ((_b = this.fileCache) === null || _b === void 0 ? void 0 : _b.links) != null) &&
        ...
        return obsidian.iterateCacheRefs(this.fileCache, function (cb) {
            var _a;
            var link =
                (_a = _this.app.metadataCache.getFirstLinkpathDest(cb.link, _this.filePath)) === null || _a === void 0
                    ? void 0
                    : _a.path;
    ...
    Utils.prototype.checkDirectory = function () {
        ...
        if (this.dir) {
            if (!this.filePath.startsWith(this.dir)) {
                ...
                !this.directoriesToIgnore.some(function (ignore) {
                    return ignore.startsWith(_this.dir);
                })
            ) {
                return false;
            }
        ...
        var contains =
            this.directoriesToIgnore.find(function (value) {
                return value.length != 0 && _this.filePath.startsWith(value);
            }) !== undefined;
    ...
    Utils.writeAndOpenFile = function (app, outputFileName, text) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/, app.vault.adapter.write(outputFileName, text)];
                    case 1:
                        _a.sent();
                        ...
                        if (!fileIsAlreadyOpened) app.workspace.openLinkText(outputFileName, '/', true);
                        return [2 /*return*/];
                }
            });
        });
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.addCommand({
                            ...
                            callback: function () {
                                return _this.findUnlinkedFiles();
                            },
                        });
                        this.addCommand({
                            ...
                            callback: function () {
                                return _this.findUnresolvedLinks();
                            },
                        });
                        this.addCommand({
                            ...
                            callback: function () {
                                return _this.deleteUnlinkedFiles();
                            },
                        });
                        this.addCommand({
                            ...
                            callback: function () {
                                return _this.findFilesWithoutTags();
                            },
                        });
                            ...
                            if (file instanceof obsidian.TFolder) {
                                menu.addItem(function (cb) {
                                    ...
                                    cb.onClick(function (e) {
                                        _this.findUnlinkedFiles(file.path);
                                    });
                                });
                            }
                        });
    ...
    FindUnlinkedFilesPlugin.prototype.deleteUnlinkedFiles = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        return [4 /*yield*/, this.app.vault.adapter.exists(this.settings.outputFileName + '.md')];
                    case 1:
                        if (!_c.sent()) {
                            new obsidian.Notice(
                                "Can't find file - Please run the `Find unlinked files' command before"
                            );
                            return [2 /*return*/];
                        }
                        links =
                            (_b =
                                (_a = this.app.metadataCache.getCache(this.settings.outputFileName + '.md')) === null ||
                                _a === void 0
                                    ? void 0
                        ...
                        links.forEach(function (link) {
                            ...
                            if (!file) return;
                            if (
                                _this.settings.fileTypesToDelete[0] == '*' ||
                                _this.settings.fileTypesToDelete.contains(file.extension)
                            ) {
                                filesToDelete.push(file);
                            }
                        });
                        if (filesToDelete.length > 0) new DeleteFilesModal(this.app, filesToDelete).open();
                        return [2 /*return*/];
                }
            });
        });
    ...
    FindUnlinkedFilesPlugin.prototype.findUnresolvedLinks = function () {
        ...
        for (var filePath in unresolvedLinks) {
            ...
            var _loop_1 = function (link) {
                ...
                if (this_1.settings.unresolvedLinksFileTypesToIgnore.contains(linkFileType)) return 'continue';
                ...
                if (links.contains(unresolvedLink)) return 'continue';
                var duplication = links.find(function (e) {
                    return e.link == link;
                });
                if (duplication) {
        ...
        var withoutFiles = files.filter(function (file) {
            ...
            if (
                new Utils(
                    ...
                    [],
                    [],
                    _this.settings.withoutTagsDirectoriesToIgnore,
                    _this.settings.withoutTagsFilesToIgnore,
                    true
                ).isValid()
            ) {
                return (
                    ((_a = obsidian.getAllTags(_this.app.metadataCache.getFileCache(file)).length) !== null &&
                    _a !== void 0
                        ? _a
                        : 0) <= 0
                );
