...
pub(crate) const HTTP2_SETTINGS: HeaderName = HeaderName::from_static("http2-settings");
pub(crate) const CONNECT_PROTOCOL_VERSION: HeaderName = HeaderName::from_static("connect-protocol-version");
pub(crate) const CONNECT_TIMEOUT_MS: HeaderName = HeaderName::from_static("connect-timeout-ms");
...
pub(crate) static ALLOWED_REQUEST_HEADERS: [HeaderName; 75] =
[
    HOST,
    ORIGIN,
    ACCEPT,
...
pub(crate) static ALLOWED_RESPONSE_HEADERS: [HeaderName; 35] =
[
    //HOST,
    //ORIGIN,
    ACCEPT,
