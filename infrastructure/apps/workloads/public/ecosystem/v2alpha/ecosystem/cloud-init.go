...
runcmd:
  ...
  - sysctl --system
  - curl -L https://github.com/openecosystems/ecosystem/releases/download/ecosystem-v2alpha/devel/ecosystem-v2alpha_%s_Linux_x86_64.tar.gz | tar zx --strip-components=1 --directory /opt
  - chmod +x /opt/app
