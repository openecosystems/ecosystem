# Charter for the OpenEcosystems Organization

This is the organizational charter for the OpenEcosystems Organization (the "Organization"). By adding their name to the [Steering Committee.md file](./STEERING-COMMITTEE.md), Steering Committee members agree as follows.
