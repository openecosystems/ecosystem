...
var file_platform_audit_v2alpha_audit_proto_rawDesc = []byte{
...
var (
	...
	file_platform_audit_v2alpha_audit_proto_rawDescData = file_platform_audit_v2alpha_audit_proto_rawDesc
)

func file_platform_audit_v2alpha_audit_proto_rawDescGZIP() []byte {
	file_platform_audit_v2alpha_audit_proto_rawDescOnce.Do(func() {
		file_platform_audit_v2alpha_audit_proto_rawDescData = protoimpl.X.CompressGZIP(file_platform_audit_v2alpha_audit_proto_rawDescData)
	})
...
func file_platform_audit_v2alpha_audit_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_platform_audit_v2alpha_audit_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_platform_audit_v2alpha_audit_proto_rawDesc = nil
