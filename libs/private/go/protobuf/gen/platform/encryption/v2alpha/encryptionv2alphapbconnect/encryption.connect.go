...
const (
	...
	EncryptionServiceName = "platform.encryption.v2alpha.EncryptionService"
)
...
const (
	...
	// RPC.
	EncryptionServiceEncryptProcedure = "/platform.encryption.v2alpha.EncryptionService/Encrypt"
	// EncryptionServiceDecryptProcedure is the fully-qualified name of the EncryptionService's Decrypt
	// RPC.
	EncryptionServiceDecryptProcedure = "/platform.encryption.v2alpha.EncryptionService/Decrypt"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	encryptionServiceServiceDescriptor       = v2alpha.File_platform_encryption_v2alpha_encryption_proto.Services().ByName("EncryptionService")
...
// EncryptionServiceClient is a client for the platform.encryption.v2alpha.EncryptionService
// service.
...
// platform.encryption.v2alpha.EncryptionService service. By default, it uses the Connect protocol
...
// Encrypt calls platform.encryption.v2alpha.EncryptionService.Encrypt.
...
// Decrypt calls platform.encryption.v2alpha.EncryptionService.Decrypt.
...
// platform.encryption.v2alpha.EncryptionService service.
...
func NewEncryptionServiceHandler(svc EncryptionServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/platform.encryption.v2alpha.EncryptionService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedEncryptionServiceHandler) Encrypt(context.Context, *connect.Request[v2alpha.EncryptRequest]) (*connect.Response[v2alpha.EncryptResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("platform.encryption.v2alpha.EncryptionService.Encrypt is not implemented"))
}
...
func (UnimplementedEncryptionServiceHandler) Decrypt(context.Context, *connect.Request[v2alpha.DecryptRequest]) (*connect.Response[v2alpha.DecryptResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("platform.encryption.v2alpha.EncryptionService.Decrypt is not implemented"))
}
