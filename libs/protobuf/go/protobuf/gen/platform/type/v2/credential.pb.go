...
const (
	...
	CredentialType_CREDENTIAL_TYPE_MESH_ACCOUNT CredentialType = 1 // Credential for a mesh service account.
)
...
var (
	CredentialType_name = map[int32]string{
		...
		1: "CREDENTIAL_TYPE_MESH_ACCOUNT",
	}
	CredentialType_value = map[string]int32{
		"CREDENTIAL_TYPE_UNSPECIFIED":  0,
		"CREDENTIAL_TYPE_MESH_ACCOUNT": 1,
	}
)
...
type Credential struct {
	...
	AaCertX509     string                 `protobuf:"bytes,6,opt,name=aa_cert_x509,json=aaCertX509,proto3" json:"aa_cert_x509,omitempty"`
	CertX509       string                 `protobuf:"bytes,7,opt,name=cert_x509,json=certX509,proto3" json:"cert_x509,omitempty"`
	CertX509QrCode string                 `protobuf:"bytes,8,opt,name=cert_x509_qr_code,json=certX509QrCode,proto3" json:"cert_x509_qr_code,omitempty"`
	PrivateKey     string                 `protobuf:"bytes,9,opt,name=private_key,json=privateKey,proto3" json:"private_key,omitempty"`
	NKey           string                 `protobuf:"bytes,10,opt,name=n_key,json=nKey,proto3" json:"n_key,omitempty"`
	Groups         []string               `protobuf:"bytes,11,rep,name=groups,proto3" json:"groups,omitempty"`
	Subnets        []string               `protobuf:"bytes,12,rep,name=subnets,proto3" json:"subnets,omitempty"`
...
var file_platform_type_v2_credential_proto_rawDesc = string([]byte{
	...
	0x70, 0x65, 0x2e, 0x76, 0x32, 0x22, 0xa1, 0x03, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e,
	...
	,
	...
	0x4d, 0x45, 0x53, 0x48, 0x5f, 0x41, 0x43, 0x43, 0x4f, 0x55, 0x4e, 0x54, 0x10, 0x01, 0x42, 0x39,
...
var file_platform_type_v2_credential_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_platform_type_v2_credential_proto_goTypes = []any{
	...
	(*Credential)(nil),  // 1: platform.type.v2.Credential
}
