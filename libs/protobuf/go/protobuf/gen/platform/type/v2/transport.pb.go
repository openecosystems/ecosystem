...
var file_platform_type_v2_transport_proto_rawDesc = []byte{
	...
	0x51, 0x55, 0x49, 0x43, 0x10, 0x06, 0x42, 0x39, 0x5a, 0x37, 0x6c, 0x69, 0x62, 0x73, 0x2f, 0x70,
...
var (
	...
	file_platform_type_v2_transport_proto_rawDescData = file_platform_type_v2_transport_proto_rawDesc
)

func file_platform_type_v2_transport_proto_rawDescGZIP() []byte {
	file_platform_type_v2_transport_proto_rawDescOnce.Do(func() {
		file_platform_type_v2_transport_proto_rawDescData = protoimpl.X.CompressGZIP(file_platform_type_v2_transport_proto_rawDescData)
	})
...
func file_platform_type_v2_transport_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_platform_type_v2_transport_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_platform_type_v2_transport_proto_rawDesc = nil
