...
import (
	v21 "github.com/openecosystems/ecosystem/libs/protobuf/go/sdk/v2beta/gen/platform/options/v2"
...
const file_platform_spec_v2_spec_proto_rawDesc = "" +
	...
	"\n" +
	"field_mask\x18\x03 \x01(\v2\x1a.google.protobuf.FieldMaskR\tfieldMask:\x06\xfa\xb6\x18\x02\b\x01\"\xe3\x01\n" +
	"\x12SpecRequestContext\x12R\n" +
	"\x12request_validation\x18\x01 \x01(\v2#.platform.type.v2.RequestValidationR\x11requestValidation\x12+\n" +
	"\x11organization_slug\x18\x02 \x01(\tR\x10organizationSlug\x12%\n" +
	"\x0eworkspace_slug\x18\x03 \x01(\tR\rworkspaceSlug\x12\x1d\n" +
	"\n" +
	"routine_id\x18\x04 \x01(\tR\troutineId:\x06\xfa\xb6\x18\x02\b\x01\"\x98\x03\n" +
	...
	"\x1aSPEC_PRINCIPAL_TYPE_DOMAIN\x10\x04Be\x9a\xb5\x18\x02\b\x01Z]github.com/openecosystems/ecosystem/libs/protobuf/go/sdk/v2beta/gen/platform/spec/v2;specv2pbb\x06proto3"
