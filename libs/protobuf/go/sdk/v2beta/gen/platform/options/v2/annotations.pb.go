...
const file_platform_options_v2_annotations_proto_rawDesc = "" +
	...
	"\x05limit\x18\x01 \x01(\bR\x05limit\"h\n" +
	"\x11PermissionOptions\x12\x1e\n" +
	"\n" +
	"permission\x18\x01 \x01(\tR\n" +
	"permission\x123\n" +
	"\x05roles\x18\x02 \x03(\x0e2\x1d.platform.options.v2.AuthRoleR\x05roles\"B\n" +
	"\fGraphOptions\x122\n" +
	...
	"\x05event\x12!.google.protobuf.EnumValueOptions\x18\x8f\x87\x03 \x01(\v2!.platform.options.v2.EventOptionsR\x05eventBdZbgithub.com/openecosystems/ecosystem/libs/protobuf/go/sdk/v2beta/gen/platform/options/v2;optionv2pbb\x06proto3"
