...
export declare type SpecPlatformConfiguration = Message<"platform.configuration.v2alpha.SpecPlatformConfiguration"> & {
  ...
  /**
   * @generated from field: platform.cryptography.v2alpha.EncryptionConfiguration encryption_configuration_v2alpha = 4;
   */
  encryptionConfigurationV2alpha?: EncryptionConfiguration;

  /**
   * @generated from field: platform.dns.v2alpha.DynamicDnsConfiguration dynamic_dns_configuration_v2alpha = 5;
   */
  dynamicDnsConfigurationV2alpha?: DynamicDnsConfiguration;

  /**
   * @generated from field: platform.ecosystem.v2alpha.EcosystemConfiguration ecosystem_configuration_v2alpha = 6;
   */
  ecosystemConfigurationV2alpha?: EcosystemConfiguration;

  /**
   * @generated from field: platform.edge.v2alpha.EdgeRouterConfiguration edge_router_configuration_v2alpha = 7;
   */
  edgeRouterConfigurationV2alpha?: EdgeRouterConfiguration;

  /**
   * @generated from field: platform.iam.v2alpha.AccountAuthorityConfiguration account_authority_configuration_v2alpha = 8;
   */
  accountAuthorityConfigurationV2alpha?: AccountAuthorityConfiguration;

  /**
   * @generated from field: platform.mesh.v2alpha.CryptographicMeshConfiguration cryptographic_mesh_configuration_v2alpha = 9;
   */
  cryptographicMeshConfigurationV2alpha?: CryptographicMeshConfiguration;

  /**
   * @generated from field: platform.reference.v2alpha.ReferenceConfiguration reference_configuration_v2alpha = 10;
   */
  referenceConfigurationV2alpha?: ReferenceConfiguration;

  /**
   * @generated from field: platform.system.v2alpha.SystemConfiguration system_configuration_v2alpha = 11;
   */
  systemConfigurationV2alpha?: SystemConfiguration;

  /**
   * @generated from field: platform.communication.v1beta.PreferenceCenterConfiguration preference_center_configuration_v1beta = 12;
   */
  preferenceCenterConfigurationV1beta?: PreferenceCenterConfiguration;

  /**
   * @generated from field: platform.communication.v1alpha.PreferenceCenterConfiguration preference_center_configuration_v1alpha = 13;
   */
