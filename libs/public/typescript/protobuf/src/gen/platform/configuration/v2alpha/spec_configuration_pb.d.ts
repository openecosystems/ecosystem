...
export declare type SpecPlatformConfiguration = Message<"platform.configuration.v2alpha.SpecPlatformConfiguration"> & {
  ...
  /**
   * @generated from field: platform.cli.v2alpha.OecoConfiguration oeco_configuration_v2alpha = 4;
   */
  ...
  /**
   * @generated from field: platform.iam.v2alpha.AccountAuthorityConfiguration account_authority_configuration_v2alpha = 9;
   */
  accountAuthorityConfigurationV2alpha?: AccountAuthorityConfiguration;

  /**
   * @generated from field: platform.mesh.v2alpha.CryptographicMeshConfiguration cryptographic_mesh_configuration_v2alpha = 10;
   */
  cryptographicMeshConfigurationV2alpha?: CryptographicMeshConfiguration;

  /**
   * @generated from field: platform.reference.v2alpha.ReferenceConfiguration reference_configuration_v2alpha = 11;
   */
  referenceConfigurationV2alpha?: ReferenceConfiguration;

  /**
   * @generated from field: platform.system.v2alpha.SystemConfiguration system_configuration_v2alpha = 12;
   */
  systemConfigurationV2alpha?: SystemConfiguration;

  /**
   * @generated from field: platform.communication.v1beta.PreferenceCenterConfiguration preference_center_configuration_v1beta = 13;
   */
