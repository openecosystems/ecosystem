...
var file_platform_event_v2alpha_event_subscription_proto_rawDesc = string([]byte{
...
var (
	...
	file_platform_event_v2alpha_event_subscription_proto_rawDescData []byte
)
...
func file_platform_event_v2alpha_event_subscription_proto_rawDescGZIP() []byte {
	file_platform_event_v2alpha_event_subscription_proto_rawDescOnce.Do(func() {
		file_platform_event_v2alpha_event_subscription_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_platform_event_v2alpha_event_subscription_proto_rawDesc), len(file_platform_event_v2alpha_event_subscription_proto_rawDesc)))
	})
...
func file_platform_event_v2alpha_event_subscription_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_platform_event_v2alpha_event_subscription_proto_rawDesc), len(file_platform_event_v2alpha_event_subscription_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
