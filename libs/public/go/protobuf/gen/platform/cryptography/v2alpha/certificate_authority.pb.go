...
var file_platform_cryptography_v2alpha_certificate_authority_proto_rawDesc = string([]byte{
...
var (
	...
	file_platform_cryptography_v2alpha_certificate_authority_proto_rawDescData []byte
)
...
func file_platform_cryptography_v2alpha_certificate_authority_proto_rawDescGZIP() []byte {
	file_platform_cryptography_v2alpha_certificate_authority_proto_rawDescOnce.Do(func() {
		file_platform_cryptography_v2alpha_certificate_authority_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_platform_cryptography_v2alpha_certificate_authority_proto_rawDesc), len(file_platform_cryptography_v2alpha_certificate_authority_proto_rawDesc)))
	})
...
func file_platform_cryptography_v2alpha_certificate_authority_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_platform_cryptography_v2alpha_certificate_authority_proto_rawDesc), len(file_platform_cryptography_v2alpha_certificate_authority_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
