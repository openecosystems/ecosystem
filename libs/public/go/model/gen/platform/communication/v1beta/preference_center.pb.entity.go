...
func NewPreferenceCenterSpecEntityFromSpec(ctx context.Context, s *specv2pb.Spec) (*PreferenceCenterSpecEntity, error) {
	data := &communicationv1betapb.PreferenceCenter{}
	err := sdkv2alphalib.GetDataFromSpec[*communicationv1betapb.PreferenceCenter](ctx, s, data)
	if err != nil {
...
func (entity *PreferenceCenterSpecEntity) ToProto() (*communicationv1betapb.PreferenceCenter, error) {
