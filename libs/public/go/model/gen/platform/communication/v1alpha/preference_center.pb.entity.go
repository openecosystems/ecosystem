...
package communicationv1alphapbmodel
...
type PreferenceCenterSpecEntity struct {
	PreferenceCenter *communicationv1alphapb.PreferenceCenter
}
...
func NewPreferenceCenterSpecEntityFromSpec(ctx context.Context, s *specv2pb.Spec) (*PreferenceCenterSpecEntity, error) {
	data := &communicationv1alphapb.PreferenceCenter{}
	err := sdkv2alphalib.GetDataFromSpec[*communicationv1alphapb.PreferenceCenter](ctx, s, data)
	if err != nil {
...
func (entity *PreferenceCenterSpecEntity) ToProto() (*communicationv1alphapb.PreferenceCenter, error) {
