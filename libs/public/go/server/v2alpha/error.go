...
var ErrServerInternal sdkv2alphalib.SpecError = &sdkv2alphalib.Error{SpecApiErr: &sdkv2alphalib.SpecApiError{Error: *sdkv2alphalib.NewConnectError(connect.CodeInternal, &SpecServerInternalErrorDetail, "Error on our side")}}
