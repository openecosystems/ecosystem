...
func NewIamApiKeyServiceSpecClient(config *specv2pb.SpecSettings, baseURL string, opts ...connect.ClientOption) *iamv2alphapbconnect.IamApiKeyServiceClient {

	//httpClient := clientv2alphalib.GetMeshHttpClient(config, baseURL)
	httpClient := http.DefaultClient
	c := iamv2alphapbconnect.NewIamApiKeyServiceClient(httpClient, baseURL, opts...)
	return &c
}
