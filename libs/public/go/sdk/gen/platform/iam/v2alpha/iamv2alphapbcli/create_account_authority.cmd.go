...
var CreateAccountAuthorityV2AlphaCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		client := *iamv2alphapbconnect.NewAccountAuthorityServiceSpecClient(&settings.Platform, url, connect.WithInterceptors(sdkv2alphalib.NewCLIInterceptor(settings, sdkv2alphalib.Overrides)))
