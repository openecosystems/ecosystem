...
var CreateAccountAuthorityV2AlphaCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		_r := CreateAccountAuthorityRequest{}
		...
		request := connect.NewRequest[CreateAccountAuthorityRequest](&_r)
		...
		client := *NewAccountAuthorityServiceSpecClient(&settings.Platform, url, connect.WithInterceptors(sdkv2alphalib.NewCLIInterceptor(settings, sdkv2alphalib.Overrides)))
