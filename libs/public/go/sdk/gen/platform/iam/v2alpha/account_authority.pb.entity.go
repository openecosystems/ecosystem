...
func NewAccountAuthoritySpecEntityFromSpec(ctx context.Context, s *specv2pb.Spec) (*AccountAuthoritySpecEntity, error) {
	data := &AccountAuthority{}
	err := sdkv2alphalib.GetDataFromSpec[*AccountAuthority](ctx, s, data)
	if err != nil {
...
func (entity *AccountAuthoritySpecEntity) ToProto() (*AccountAuthority, error) {
