...
func NewConfigurationSpecEntityFromSpec(ctx context.Context, s *specv2pb.Spec) (*ConfigurationSpecEntity, error) {
	data := &Configuration{}
	err := sdkv2alphalib.GetDataFromSpec[*Configuration](ctx, s, data)
	if err != nil {
...
func (entity *ConfigurationSpecEntity) ToProto() (*Configuration, error) {
...
func (entity *ConfigurationSpecEntity) internal() {
	...
	// Enum
	var _ *ConfigurationType

	// Enum
	var _ *ConfigurationStatus

	// Struct
	var _ *ontologyv2alphapb.SpecDataCatalog

	// Struct
	var _ *SpecPlatformConfiguration
