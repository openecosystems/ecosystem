...
const file_platform_configuration_v2alpha_configuration_proto_rawDesc = "" +
	...
	"\x13CreateConfiguration\x12:.platform.configuration.v2alpha.CreateConfigurationRequest\x1a;.platform.configuration.v2alpha.CreateConfigurationResponse\"/\xa2\xb6\x18\b*\x06create\xaa\xb6\x18\x02\b\x02\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/v2/configurations\x12\xb7\x01\n" +
	"\x12ListConfigurations\x129.platform.configuration.v2alpha.ListConfigurationsRequest\x1a:.platform.configuration.v2alpha.ListConfigurationsResponse\"*\xa2\xb6\x18\x06*\x04list\xaa\xb6\x18\x02\b\b\x82\xd3\xe4\x93\x02\x14\x12\x12/v2/configurations\x12\xb5\x01\n" +
	"\x10GetConfiguration\x127.platform.configuration.v2alpha.GetConfigurationRequest\x1a8.platform.configuration.v2alpha.GetConfigurationResponse\".\xa2\xb6\x18\x05*\x03get\xaa\xb6\x18\x02\b\n" +
	"\x82\xd3\xe4\x93\x02\x19\x12\x17/v2/configurations/{id}\x12\xcb\x01\n" +
	"\x13UpdateConfiguration\x12:.platform.configuration.v2alpha.UpdateConfigurationRequest\x1a;.platform.configuration.v2alpha.UpdateConfigurationResponse\";\xa2\xb6\x18\b*\x06update\xaa\xb6\x18\x02\b\x03\x82\xd3\xe4\x93\x02#:\x01*\x1a\x1e/v2/configurations/{config.id}\x12\xc8\x01\n" +
	"\x11LoadConfiguration\x128.platform.configuration.v2alpha.LoadConfigurationRequest\x1a9.platform.configuration.v2alpha.LoadConfigurationResponse\">\xa2\xb6\x18\x06*\x04load\xaa\xb6\x18\x02\b\x03\x82\xd3\xe4\x93\x02(:\x01*\x1a#/v2/configurations/load/{config.id}\x12\xc1\x01\n" +
	"\x13DeleteConfiguration\x12:.platform.configuration.v2alpha.DeleteConfigurationRequest\x1a;.platform.configuration.v2alpha.DeleteConfigurationResponse\"1\xa2\xb6\x18\b*\x06delete\xaa\xb6\x18\x02\b\x04\x82\xd3\xe4\x93\x02\x19*\x17/v2/configurations/{id}\x12\xcd\x01\n" +
	"\x14PublishConfiguration\x12;.platform.configuration.v2alpha.PublishConfigurationRequest\x1a<.platform.configuration.v2alpha.PublishConfigurationResponse\":\xa2\xb6\x18\t*\apublish\xaa\xb6\x18\x02\b\x03\x82\xd3\xe4\x93\x02!\"\x1f/v2/configurations/publish/{id}\x12\xcd\x01\n" +
	"\x14ArchiveConfiguration\x12;.platform.configuration.v2alpha.ArchiveConfigurationRequest\x1a<.platform.configuration.v2alpha.ArchiveConfigurationResponse\":\xa2\xb6\x18\t*\aarchive\xaa\xb6\x18\x02\b\x03\x82\xd3\xe4\x93\x02!\"\x1f/v2/configurations/archive/{id}B\xbf\x01\x82\xc4\x13\x02\b\x02\x82\xb5\x18\x06\b\x03\x10\x01\x18\x02\x8a\xb5\x18(\n" +
