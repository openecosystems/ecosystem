...
const file_platform_configuration_v2alpha_configuration_proto_rawDesc = "" +
	"\n" +
	"2platform/configuration/v2alpha/configuration.proto\x12\x1eplatform.configuration.v2alpha\x1a\x19google/protobuf/any.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a7platform/configuration/v2alpha/spec_configuration.proto\x1a1platform/ontology/v2alpha/spec_data_catalog.proto\x1a%platform/options/v2/annotations.proto\x1a\x1bplatform/spec/v2/spec.proto\x1a\x1bbuf/validate/validate.proto\"\x88\x01\n" +
	"\x1aCreateConfigurationRequest\x12E\n" +
	"\x04type\x18\x02 \x01(\x0e21.platform.configuration.v2alpha.ConfigurationTypeR\x04type\x12\x1b\n" +
	"\tparent_id\x18\x03 \x01(\tR\bparentId:\x06\xfa\xb6\x18\x02\b\x01\"\xc4\x01\n" +
	"\x1bCreateConfigurationResponse\x12H\n" +
	"\fspec_context\x18\x01 \x01(\v2%.platform.spec.v2.SpecResponseContextR\vspecContext\x12S\n" +
	"\rconfiguration\x18\x02 \x01(\v2-.platform.configuration.v2alpha.ConfigurationR\rconfiguration:\x06\xfa\xb6\x18\x02\b\x02\"1\n" +
	"\x17GetConfigurationRequest\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id:\x06\xfa\xb6\x18\x02\b\x01\"\xc1\x01\n" +
	"\x18GetConfigurationResponse\x12H\n" +
	"\fspec_context\x18\x01 \x01(\v2%.platform.spec.v2.SpecResponseContextR\vspecContext\x12S\n" +
	"\rconfiguration\x18\x02 \x01(\v2-.platform.configuration.v2alpha.ConfigurationR\rconfiguration:\x06\xfa\xb6\x18\x02\b\x02\"j\n" +
	"\x19ListConfigurationsRequest\x12&\n" +
	"\tpage_size\x18\x02 \x01(\x05B\t\xbaH\x06\x1a\x04\x18\x19 \x01R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x03 \x01(\tR\tpageToken:\x06\xfa\xb6\x18\x02\b\x01\"\x8c\x02\n" +
	"\x1aListConfigurationsResponse\x12H\n" +
	...
	"\x0fnext_page_token\x18\x03 \x01(\tR\rnextPageToken\x12U\n" +
	"\x0econfigurations\x18\x04 \x03(\v2-.platform.configuration.v2alpha.ConfigurationR\x0econfigurations:\x06\xfa\xb6\x18\x02\b\x02\"6\n" +
	"\x14ConfigurationsFilter\x12\x16\n" +
	"\x06filter\x18\x01 \x01(\tR\x06filter:\x06\xfa\xb6\x18\x02\b\x01\"k\n" +
	"\x1aUpdateConfigurationRequest\x12E\n" +
	"\x06config\x18\x02 \x01(\v2-.platform.configuration.v2alpha.ConfigurationR\x06config:\x06\xfa\xb6\x18\x02\b\x01\"\xc4\x01\n" +
	"\x1bUpdateConfigurationResponse\x12H\n" +
	"\fspec_context\x18\x01 \x01(\v2%.platform.spec.v2.SpecResponseContextR\vspecContext\x12S\n" +
	"\rconfiguration\x18\x02 \x01(\v2-.platform.configuration.v2alpha.ConfigurationR\rconfiguration:\x06\xfa\xb6\x18\x02\b\x02\"i\n" +
	"\x18LoadConfigurationRequest\x12E\n" +
	"\x06config\x18\x02 \x01(\v2-.platform.configuration.v2alpha.ConfigurationR\x06config:\x06\xfa\xb6\x18\x02\b\x01\"\xc2\x01\n" +
	"\x19LoadConfigurationResponse\x12H\n" +
	"\fspec_context\x18\x01 \x01(\v2%.platform.spec.v2.SpecResponseContextR\vspecContext\x12S\n" +
	"\rconfiguration\x18\x02 \x01(\v2-.platform.configuration.v2alpha.ConfigurationR\rconfiguration:\x06\xfa\xb6\x18\x02\b\x02\"4\n" +
	"\x1aDeleteConfigurationRequest\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id:\x06\xfa\xb6\x18\x02\b\x01\"\xc4\x01\n" +
	"\x1bDeleteConfigurationResponse\x12H\n" +
	"\fspec_context\x18\x01 \x01(\v2%.platform.spec.v2.SpecResponseContextR\vspecContext\x12S\n" +
	"\rconfiguration\x18\x02 \x01(\v2-.platform.configuration.v2alpha.ConfigurationR\rconfiguration:\x06\xfa\xb6\x18\x02\b\x02\"|\n" +
	"\x1bPublishConfigurationRequest\x12E\n" +
	"\x06config\x18\x02 \x01(\v2-.platform.configuration.v2alpha.ConfigurationR\x06config\x12\x0e\n" +
	"\x02id\x18\x03 \x01(\tR\x02id:\x06\xfa\xb6\x18\x02\b\x01\"\xc5\x01\n" +
	"\x1cPublishConfigurationResponse\x12H\n" +
	"\fspec_context\x18\x01 \x01(\v2%.platform.spec.v2.SpecResponseContextR\vspecContext\x12S\n" +
	"\rconfiguration\x18\x02 \x01(\v2-.platform.configuration.v2alpha.ConfigurationR\rconfiguration:\x06\xfa\xb6\x18\x02\b\x02\"|\n" +
	"\x1bArchiveConfigurationRequest\x12E\n" +
	"\x06config\x18\x02 \x01(\v2-.platform.configuration.v2alpha.ConfigurationR\x06config\x12\x0e\n" +
	"\x02id\x18\x03 \x01(\tR\x02id:\x06\xfa\xb6\x18\x02\b\x01\"\xc5\x01\n" +
	"\x1cArchiveConfigurationResponse\x12H\n" +
	"\fspec_context\x18\x01 \x01(\v2%.platform.spec.v2.SpecResponseContextR\vspecContext\x12S\n" +
	"\rconfiguration\x18\x02 \x01(\v2-.platform.configuration.v2alpha.ConfigurationR\rconfiguration:\x06\xfa\xb6\x18\x02\b\x02\"\xe1\v\n" +
	"\rConfiguration\x12\x16\n" +
	"\x02id\x18\x01 \x01(\tB\x06ʷ\x18\x02\b\x01R\x02id\x124\n" +
	"\x11organization_slug\x18\x02 \x01(\tB\aʷ\x18\x03\x12\x01\x05R\x10organizationSlug\x12.\n" +
	"\x0eworkspace_slug\x18\x03 \x01(\tB\aʷ\x18\x03\x12\x01\x05R\rworkspaceSlug\x12B\n" +
	"\n" +
	"created_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampB\aʷ\x18\x03\x12\x01\x03R\tcreatedAt\x12B\n" +
	"\n" +
	"updated_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB\aʷ\x18\x03\x12\x01\x03R\tupdatedAt\x12$\n" +
	"\tsource_id\x18\x06 \x01(\tB\aʷ\x18\x03\x12\x01\x05R\bsourceId\x12N\n" +
	"\x04type\x18\a \x01(\x0e21.platform.configuration.v2alpha.ConfigurationTypeB\aʷ\x18\x03\x12\x01\x05R\x04type\x12T\n" +
	"\x06status\x18\b \x01(\x0e23.platform.configuration.v2alpha.ConfigurationStatusB\aʷ\x18\x03\x12\x01\x03R\x06status\x12.\n" +
	"\x0estatus_details\x18\t \x01(\tB\aʷ\x18\x03\x12\x01\x03R\rstatusDetails\x12$\n" +
	"\tparent_id\x18\n" +
	" \x01(\tB\aʷ\x18\x03\x12\x01\x05R\bparentId\x12M\n" +
	"\fdata_catalog\x18\r \x01(\v2*.platform.ontology.v2alpha.SpecDataCatalogR\vdataCatalog\x12)\n" +
	"\x10clinical_catalog\x18\x0e \x01(\tR\x0fclinicalCatalog\x12p\n" +
	"\x16platform_configuration\x18\x0f \x01(\v29.platform.configuration.v2alpha.SpecPlatformConfigurationR\x15platformConfiguration\x12\x82\x01\n" +
	"\x17platform_configurations\x18\x10 \x03(\v2I.platform.configuration.v2alpha.Configuration.PlatformConfigurationsEntryR\x16platformConfigurations\x12\x82\x01\n" +
	"\x17solution_configurations\x18\x11 \x03(\v2I.platform.configuration.v2alpha.Configuration.SolutionConfigurationsEntryR\x16solutionConfigurations\x12\x85\x01\n" +
	"\x18connector_configurations\x18\x12 \x03(\v2J.platform.configuration.v2alpha.Configuration.ConnectorConfigurationsEntryR\x17connectorConfigurations\x1a_\n" +
	"\x1bPlatformConfigurationsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\x05value:\x028\x01\x1a_\n" +
	"\x1bSolutionConfigurationsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\x05value:\x028\x01\x1a`\n" +
	"\x1cConnectorConfigurationsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\x05value:\x028\x01:\x06\xfa\xb6\x18\x02\b\x02*\xaa\x01\n" +
	"\x11ConfigurationType\x12\"\n" +
	"\x1eCONFIGURATION_TYPE_UNSPECIFIED\x10\x00\x12#\n" +
	"\x1fCONFIGURATION_TYPE_ORGANIZATION\x10\x01\x12 \n" +
	"\x1cCONFIGURATION_TYPE_WORKSPACE\x10\x02\x12*\n" +
	"&CONFIGURATION_TYPE_CONFIGURATION_GROUP\x10\x03*\x88\x02\n" +
	"\x13ConfigurationStatus\x12$\n" +
	" CONFIGURATION_STATUS_UNSPECIFIED\x10\x00\x12!\n" +
	"\x1dCONFIGURATION_STATUS_CREATING\x10\x01\x12\x1f\n" +
	"\x1bCONFIGURATION_STATUS_ACTIVE\x10\x02\x12!\n" +
	"\x1dCONFIGURATION_STATUS_INACTIVE\x10\x03\x12!\n" +
	"\x1dCONFIGURATION_STATUS_UPDATING\x10\x04\x12!\n" +
	"\x1dCONFIGURATION_STATUS_DELETING\x10\x05\x12\x1e\n" +
	"\x1aCONFIGURATION_STATUS_ERROR\x10\x06*\xf0\x01\n" +
	"\x1aConfigurationBillingStatus\x12,\n" +
	"(CONFIGURATION_BILLING_STATUS_UNSPECIFIED\x10\x00\x12'\n" +
	"#CONFIGURATION_BILLING_STATUS_ACTIVE\x10\x01\x12)\n" +
	"%CONFIGURATION_BILLING_STATUS_INACTIVE\x10\x02\x12(\n" +
	"$CONFIGURATION_BILLING_STATUS_WARNING\x10\x03\x12&\n" +
	"\"CONFIGURATION_BILLING_STATUS_ERROR\x10\x04*\xb0\x01\n" +
	"\x15ConfigurationCommands\x12&\n" +
	"\"CONFIGURATION_COMMANDS_UNSPECIFIED\x10\x00\x12!\n" +
	"\x1dCONFIGURATION_COMMANDS_CREATE\x10\x01\x12!\n" +
	"\x1dCONFIGURATION_COMMANDS_UPDATE\x10\x02\x12!\n" +
	"\x1dCONFIGURATION_COMMANDS_DELETE\x10\x03\x1a\x06\x92\xb8\x18\x02\b\x03*\xb9\x01\n" +
	"\x13ConfigurationEvents\x12$\n" +
	" CONFIGURATION_EVENTS_UNSPECIFIED\x10\x00\x12(\n" +
	"\x1cCONFIGURATION_EVENTS_CREATED\x10\x01\x1a\x06\xfa\xb8\x18\x02\b\x01\x12(\n" +
	"\x1cCONFIGURATION_EVENTS_UPDATED\x10\x02\x1a\x06\xfa\xb8\x18\x02\b\x01\x12 \n" +
	"\x1cCONFIGURATION_EVENTS_DELETED\x10\x03\x1a\x06\x92\xb8\x18\x02\b\x042\xc7\f\n" +
	"\x14ConfigurationService\x12\xbf\x01\n" +
	"\x13CreateConfiguration\x12:.platform.configuration.v2alpha.CreateConfigurationRequest\x1a;.platform.configuration.v2alpha.CreateConfigurationResponse\"/\xa2\xb6\x18\b2\x06create\xaa\xb6\x18\x02\b\x02\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/v2/configurations\x12\xb7\x01\n" +
	"\x12ListConfigurations\x129.platform.configuration.v2alpha.ListConfigurationsRequest\x1a:.platform.configuration.v2alpha.ListConfigurationsResponse\"*\xa2\xb6\x18\x062\x04list\xaa\xb6\x18\x02\b\b\x82\xd3\xe4\x93\x02\x14\x12\x12/v2/configurations\x12\xb5\x01\n" +
	"\x10GetConfiguration\x127.platform.configuration.v2alpha.GetConfigurationRequest\x1a8.platform.configuration.v2alpha.GetConfigurationResponse\".\xa2\xb6\x18\x052\x03get\xaa\xb6\x18\x02\b\n" +
	"\x82\xd3\xe4\x93\x02\x19\x12\x17/v2/configurations/{id}\x12\xcb\x01\n" +
	"\x13UpdateConfiguration\x12:.platform.configuration.v2alpha.UpdateConfigurationRequest\x1a;.platform.configuration.v2alpha.UpdateConfigurationResponse\";\xa2\xb6\x18\b2\x06update\xaa\xb6\x18\x02\b\x03\x82\xd3\xe4\x93\x02#:\x01*\x1a\x1e/v2/configurations/{config.id}\x12\xc8\x01\n" +
	"\x11LoadConfiguration\x128.platform.configuration.v2alpha.LoadConfigurationRequest\x1a9.platform.configuration.v2alpha.LoadConfigurationResponse\">\xa2\xb6\x18\x062\x04load\xaa\xb6\x18\x02\b\x03\x82\xd3\xe4\x93\x02(:\x01*\x1a#/v2/configurations/load/{config.id}\x12\xc1\x01\n" +
	"\x13DeleteConfiguration\x12:.platform.configuration.v2alpha.DeleteConfigurationRequest\x1a;.platform.configuration.v2alpha.DeleteConfigurationResponse\"1\xa2\xb6\x18\b2\x06delete\xaa\xb6\x18\x02\b\x04\x82\xd3\xe4\x93\x02\x19*\x17/v2/configurations/{id}\x12\xcd\x01\n" +
	"\x14PublishConfiguration\x12;.platform.configuration.v2alpha.PublishConfigurationRequest\x1a<.platform.configuration.v2alpha.PublishConfigurationResponse\":\xa2\xb6\x18\t2\apublish\xaa\xb6\x18\x02\b\x03\x82\xd3\xe4\x93\x02!\"\x1f/v2/configurations/publish/{id}\x12\xcd\x01\n" +
	"\x14ArchiveConfiguration\x12;.platform.configuration.v2alpha.ArchiveConfigurationRequest\x1a<.platform.configuration.v2alpha.ArchiveConfigurationResponse\":\xa2\xb6\x18\t2\aarchive\xaa\xb6\x18\x02\b\x03\x82\xd3\xe4\x93\x02!\"\x1f/v2/configurations/archive/{id}B\xbf\x01\x82\xc4\x13\x02\b\x02\x82\xb5\x18\x06\b\x03\x10\x01\x18\x02\x8a\xb5\x18(\n" +
	"\rconfiguration\x12\x0econfigurations\"\x03jan(\x028\x01\x92\xb5\x18\x03\n" +
	"\x01\x03\x9a\xb5\x18\x02\b\x01\xa2\xb5\x18\x00Zpgithub.com/openecosystems/ecosystem/libs/public/go/sdk/gen/platform/configuration/v2alpha;configurationv2alphapbb\x06proto3"
