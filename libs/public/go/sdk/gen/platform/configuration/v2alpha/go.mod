...
// sourcePath: libs/public/go/sdk/gen/configuration/v2alpha
module github.com/openecosystems/ecosystem/libs/public/go/sdk/gen/platform/configuration/v2alpha
go 1.23.4
