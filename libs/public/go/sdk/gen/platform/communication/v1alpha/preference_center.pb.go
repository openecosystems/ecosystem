...
const file_platform_communication_v1alpha_preference_center_proto_rawDesc = "" +
	"\n" +
	"6platform/communication/v1alpha/preference_center.proto\x12\x1eplatform.communication.v1alpha\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a%platform/options/v2/annotations.proto\x1a\x1bplatform/spec/v2/spec.proto\x1a\x1bbuf/validate/validate.proto\"\x1f\n" +
	...
	"segmentIds:\x06\xfa\xb6\x18\x02\b\x01\"\xd3\x01\n" +
	" CreateOrUpdatePreferenceResponse\x12H\n" +
	"\fspec_context\x18\x01 \x01(\v2%.platform.spec.v2.SpecResponseContextR\vspecContext\x12]\n" +
	"\x11preference_center\x18\x02 \x01(\v20.platform.communication.v1alpha.PreferenceCenterR\x10preferenceCenter:\x06\xfa\xb6\x18\x02\b\x02\"\xbb\x01\n" +
	...
	"\vexternal_id\x18\x03 \x01(\tR\n" +
	"externalId\x12*\n" +
	"\fphone_number\x18\x04 \x01(\tB\a\xbaH\x04r\x02\x18 R\vphoneNumber:\x06\xfa\xb6\x18\x02\b\x01\"\xcb\x01\n" +
	"\x18DeletePreferenceResponse\x12H\n" +
	"\fspec_context\x18\x01 \x01(\v2%.platform.spec.v2.SpecResponseContextR\vspecContext\x12]\n" +
	"\x11preference_center\x18\x02 \x01(\v20.platform.communication.v1alpha.PreferenceCenterR\x10preferenceCenter:\x06\xfa\xb6\x18\x02\b\x02\":\n" +
	"\x14GetPreferenceRequest\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x03\x18\x80\x02R\x02id:\x06\xfa\xb6\x18\x02\b\x01\"\xc8\x01\n" +
	"\x15GetPreferenceResponse\x12H\n" +
	"\fspec_context\x18\x01 \x01(\v2%.platform.spec.v2.SpecResponseContextR\vspecContext\x12]\n" +
	"\x11preference_center\x18\x02 \x01(\v20.platform.communication.v1alpha.PreferenceCenterR\x10preferenceCenter:\x06\xfa\xb6\x18\x02\b\x02\"%\n" +
	"\x1bGetPreferenceOptionsRequest:\x06\xfa\xb6\x18\x02\b\x01\"\x9a\x02\n" +
	"\x1cGetPreferenceOptionsResponse\x12H\n" +
	"\fspec_context\x18\x01 \x01(\v2%.platform.spec.v2.SpecResponseContextR\vspecContext\x12Q\n" +
	"\n" +
	"industries\x18\x02 \x03(\v21.platform.communication.v1alpha.EmailSubscriptionR\n" +
	"industries\x12U\n" +
	"\fcapabilities\x18\x03 \x03(\v21.platform.communication.v1alpha.EmailSubscriptionR\fcapabilities:\x06\xfa\xb6\x18\x02\b\x02\"\x82\x01\n" +
	"\x11EmailSubscription\x12I\n" +
	"\x04type\x18\x01 \x01(\x0e25.platform.communication.v1alpha.EmailSubscriptionTypeR\x04type\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\"\xfa\x04\n" +
	...
	"segmentIds\x12`\n" +
	"\x12email_subscription\x18\x10 \x03(\v21.platform.communication.v1alpha.EmailSubscriptionR\x11emailSubscription*\xd8\x01\n" +
	...
	"\"EMAIL_SUBSCRIPTION_TYPE_CAPABILITY\x10\x022\xcc\x06\n" +
	"\x17PreferenceCenterService\x12\xd8\x01\n" +
	"\x18CreateOrUpdatePreference\x12?.platform.communication.v1alpha.CreateOrUpdatePreferenceRequest\x1a@.platform.communication.v1alpha.CreateOrUpdatePreferenceResponse\"9\xaa\xb6\x18\x02\b\x02\x82\xd3\xe4\x93\x02-:\x01*\"(/v1alpha/communication/preference-center\x12\xc5\x01\n" +
	"\x10DeletePreference\x127.platform.communication.v1alpha.DeletePreferenceRequest\x1a8.platform.communication.v1alpha.DeletePreferenceResponse\">\xaa\xb6\x18\x02\b\x04\x82\xd3\xe4\x93\x022*0/v1alpha/communication/preference-center/{email}\x12\xb9\x01\n" +
	"\rGetPreference\x124.platform.communication.v1alpha.GetPreferenceRequest\x1a5.platform.communication.v1alpha.GetPreferenceResponse\";\xaa\xb6\x18\x02\b\n" +
	"\x82\xd3\xe4\x93\x02/\x12-/v1alpha/communication/preference-center/{id}\x12\xd1\x01\n" +
	"\x14GetPreferenceOptions\x12;.platform.communication.v1alpha.GetPreferenceOptionsRequest\x1a<.platform.communication.v1alpha.GetPreferenceOptionsResponse\">\xaa\xb6\x18\x02\b\n" +
	"\x82\xd3\xe4\x93\x022\x120/v1alpha/communication/preference-center/optionsB\xc7\x01\x82\xc4\x13\x02\b\x02\x82\xb5\x18\x06\b\x03\x10\x01\x18\x02\x8a\xb5\x18.\n" +
	"\x11preference_center\x12\x12preference_centers\"\x03jan(\x02\x92\xb5\x18\x03\n" +
	"\x01\x03\x9a\xb5\x18\x02\b\x01\xa2\xb5\x18\x02\b\x01Zpgithub.com/openecosystems/ecosystem/libs/public/go/sdk/gen/platform/communication/v1alpha;communicationv1alphapbb\x06proto3"

var (
	file_platform_communication_v1alpha_preference_center_proto_rawDescOnce sync.Once
	file_platform_communication_v1alpha_preference_center_proto_rawDescData []byte
)
...
func file_platform_communication_v1alpha_preference_center_proto_rawDescGZIP() []byte {
	file_platform_communication_v1alpha_preference_center_proto_rawDescOnce.Do(func() {
		file_platform_communication_v1alpha_preference_center_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_platform_communication_v1alpha_preference_center_proto_rawDesc), len(file_platform_communication_v1alpha_preference_center_proto_rawDesc)))
	})
...
func file_platform_communication_v1alpha_preference_center_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_platform_communication_v1alpha_preference_center_proto_rawDesc), len(file_platform_communication_v1alpha_preference_center_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   1,
