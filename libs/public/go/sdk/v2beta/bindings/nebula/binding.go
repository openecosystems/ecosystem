...
func (b *Binding) GetMeshListener(endpoint string) (*net.Listener, error) {
	...
	return nil, sdkv2betalib.ErrServerPreconditionFailed.WithInternalErrorDetail(errors.New("the Nebula binding is not properly configured or not set"))
}
...
func (b *Binding) GetMeshHTTPClient(config *specv2pb.Platform, _ string /*url*/) *http.Client {
	...
	// b.cp, _ = sdkv2betalib.NewCredentialProvider()
	//socket, err := b.ConfigureMeshSocket()
	//if err != nil {
