...
var CreateAccountAuthorityV2AlphaCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		client := *iamv2alphapbconnect.NewAccountAuthorityServiceSpecClient(&settings.Platform, url, connect.WithInterceptors(sdkv2betalib.NewCLIInterceptor(settings, sdkv2betalib.Overrides)))
