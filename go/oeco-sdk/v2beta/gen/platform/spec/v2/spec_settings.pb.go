...
type App struct {
	...
	EnvironmentName string                 `protobuf:"bytes,40,opt,name=environment_name,json=environmentName,proto3" json:"environment_name,omitempty"`
	EnvironmentType string                 `protobuf:"bytes,50,opt,name=environment_type,json=environmentType,proto3" json:"environment_type,omitempty"`
	Debug           bool                   `protobuf:"varint,60,opt,name=debug,proto3" json:"debug,omitempty"`
	Verbose         bool                   `protobuf:"varint,70,opt,name=verbose,proto3" json:"verbose,omitempty"`
	Quiet           bool                   `protobuf:"varint,80,opt,name=quiet,proto3" json:"quiet,omitempty"`
	LogToFile       bool                   `protobuf:"varint,90,opt,name=log_to_file,json=logToFile,proto3" json:"log_to_file,omitempty"`
	AppEndpoint     string                 `protobuf:"bytes,100,opt,name=app_endpoint,json=appEndpoint,proto3" json:"app_endpoint,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *App) GetAppEndpoint() string {
	if x != nil {
...
type Platform struct {
	...
	DynamicConfigReload bool                   `protobuf:"varint,70,opt,name=dynamic_config_reload,json=dynamicConfigReload,proto3" json:"dynamic_config_reload,omitempty"`
	Mesh                *Mesh                  `protobuf:"bytes,80,opt,name=mesh,proto3" json:"mesh,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
const file_platform_spec_v2_spec_settings_proto_rawDesc = "" +
	"\n" +
	"$platform/spec/v2/spec_settings.proto\x12\x10platform.spec.v2\x1a%platform/options/v2/annotations.proto\x1a\x1fplatform/type/v2/protocol.proto\x1a%platform/type/v2/git_repository.proto\x1a\x1dplatform/type/v2/header.proto\"\xb4\x02\n" +
	...
	"\asystems\x18\x06 \x03(\v2\x1c.platform.spec.v2.SpecSystemR\asystems:\x06\xfa\xb6\x18\x02\b\x01\"\xb4\x02\n" +
	"\x03App\x12\x12\n" +
	"\x04name\x18\n" +
	" \x01(\tR\x04name\x12\x18\n" +
	"\aversion\x18\x14 \x01(\tR\aversion\x12 \n" +
	"\vdescription\x18\x1e \x01(\tR\vdescription\x12)\n" +
	"\x10environment_name\x18( \x01(\tR\x0fenvironmentName\x12)\n" +
	"\x10environment_type\x182 \x01(\tR\x0fenvironmentType\x12\x14\n" +
	"\x05debug\x18< \x01(\bR\x05debug\x12\x18\n" +
	...
	"\x15dynamic_config_reload\x18F \x01(\bR\x13dynamicConfigReload\x12*\n" +
	"\x04mesh\x18P \x01(\v2\x16.platform.spec.v2.MeshR\x04mesh:\x06\xfa\xb6\x18\x02\b\x01\"\x86\x02\n" +
	"\x04Mesh\x12\x18\n" +
	...
	"\bregistry\x18\x04 \x01(\v2$.platform.spec.v2.DependencyRegistryR\bregistryBVZTgithub.com/openecosystems/ecosystem/go/oeco-sdk/v2beta/gen/platform/spec/v2;specv2pbb\x06proto3"
