...
const file_platform_spec_v2_spec_proto_rawDesc = "" +
	...
	"\n" +
	"spec_event\x18\b \x01(\tR\tspecEvent\x12(\n" +
	"\x04data\x18\t \x01(\v2\x14.google.protobuf.AnyR\x04data:\x06\xfa\xb6\x18\x02\b\x01\"\xb0\x05\n" +
	"\vSpecContext\x12!\n" +
	...
	"\x11organization_slug\x182 \x01(\tR\x10organizationSlug\x12\x0e\n" +
	...
	"\n" +
	"validation\x18\t \x01(\v2 .platform.spec.v2.SpecValidationR\n" +
	"validation\x12:\n" +
	"\bproducer\x18\n" +
	" \x01(\v2\x1e.platform.spec.v2.SpecProducerR\bproducer\x124\n" +
	"\x06device\x18\v \x01(\v2\x1c.platform.spec.v2.SpecDeviceR\x06device\x12:\n" +
	"\blocation\x18\f \x01(\v2\x1e.platform.spec.v2.SpecLocationR\blocation\x127\n" +
	"\anetwork\x18\r \x01(\v2\x1d.platform.spec.v2.SpecNetworkR\anetwork\x12(\n" +
	"\x02os\x18\x0e \x01(\v2\x18.platform.spec.v2.SpecOSR\x02os:\x06\xfa\xb6\x18\x02\b\x01\"\x90\x01\n" +
	...
	"\x13SPEC_EVENT_TYPE_LOG\x10\t*\xbe\x01\n" +
	"\x11SpecPrincipalType\x12#\n" +
	"\x1fSPEC_PRINCIPAL_TYPE_UNSPECIFIED\x10\x00\x12\x1c\n" +
	"\x18SPEC_PRINCIPAL_TYPE_USER\x10\x01\x12'\n" +
	"#SPEC_PRINCIPAL_TYPE_SERVICE_ACCOUNT\x10\x02\x12\x1d\n" +
	"\x19SPEC_PRINCIPAL_TYPE_GROUP\x10\x03\x12\x1e\n" +
	"\x1aSPEC_PRINCIPAL_TYPE_DOMAIN\x10\x04B\\\x9a\xb5\x18\x02\b\x01ZTgithub.com/openecosystems/ecosystem/go/oeco-sdk/v2beta/gen/platform/spec/v2;specv2pbb\x06proto3"
...
var file_platform_spec_v2_spec_proto_goTypes = []any{
	...
	(v21.AuthRole)(0),             // 23: platform.options.v2.AuthRole
...
var file_platform_spec_v2_spec_proto_depIdxs = []int32{
	...
	23, // 25: platform.spec.v2.SpecPrincipal.auth_roles:type_name -> platform.options.v2.AuthRole
	...
	24, // 28: platform.spec.v2.SpecData.field_mask:type_name -> google.protobuf.FieldMask
	25, // 29: platform.spec.v2.SpecResponseContext.response_validation:type_name -> platform.type.v2.ResponseValidation
	26, // 30: platform.spec.v2.SpecResponseContext.response_mask:type_name -> platform.type.v2.ResponseMask
	19, // 31: platform.spec.v2.SpecResponseContext.ecosystem_jan:type_name -> platform.type.v2.Jurisdiction
