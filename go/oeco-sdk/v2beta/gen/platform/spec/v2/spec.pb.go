...
type SpecContext struct {
	...
	// The ecosystem associated with this context.
	EcosystemSlug string `protobuf:"bytes,4,opt,name=ecosystem_slug,json=ecosystemSlug,proto3" json:"ecosystem_slug,omitempty"`
	// The ecosystem jan associated with this context.
	// Right now this is an enumeration with a finite number of items.
	EcosystemJan   v2.Jurisdiction      `protobuf:"varint,5,opt,name=ecosystem_jan,json=ecosystemJan,proto3,enum=platform.type.v2.Jurisdiction" json:"ecosystem_jan,omitempty"`
	ProcedureScope v21.SpecRequestScope `protobuf:"varint,6,opt,name=procedure_scope,json=procedureScope,proto3,enum=platform.options.v2.SpecRequestScope" json:"procedure_scope,omitempty"`
	// The ip address of the requester. MUST meet RFC 791 or
	Ip string `protobuf:"bytes,100,opt,name=ip,proto3" json:"ip,omitempty"`
	// The locality that applies to values in the Spec Message. MUST meet [ISO 3166](https://www.iso.org/iso-3166-country-codes.html).
	Locale string `protobuf:"bytes,101,opt,name=locale,proto3" json:"locale,omitempty"`
	...
	Timezone string `protobuf:"bytes,102,opt,name=timezone,proto3" json:"timezone,omitempty"`
	...
	UserAgent  string          `protobuf:"bytes,103,opt,name=user_agent,json=userAgent,proto3" json:"user_agent,omitempty"`
	Validation *SpecValidation `protobuf:"bytes,104,opt,name=validation,proto3" json:"validation,omitempty"`
	Producer *SpecProducer `protobuf:"bytes,105,opt,name=producer,proto3" json:"producer,omitempty"`
	Device *SpecDevice `protobuf:"bytes,106,opt,name=device,proto3" json:"device,omitempty"`
	Location *SpecLocation `protobuf:"bytes,107,opt,name=location,proto3" json:"location,omitempty"`
	Network *SpecNetwork `protobuf:"bytes,108,opt,name=network,proto3" json:"network,omitempty"`
	// The Operating System that was used to send the transaction.
	Os            *SpecOS `protobuf:"bytes,109,opt,name=os,proto3" json:"os,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SpecResponseContext struct {
	...
	EcosystemJan  v2.Jurisdiction `protobuf:"varint,52,opt,name=ecosystem_jan,json=ecosystemJan,proto3,enum=platform.type.v2.Jurisdiction" json:"ecosystem_jan,omitempty"`
	RoutineId     string          `protobuf:"bytes,53,opt,name=routine_id,json=routineId,proto3" json:"routine_id,omitempty"`
	CorrelationId string          `protobuf:"bytes,54,opt,name=correlation_id,json=correlationId,proto3" json:"correlation_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SpecResponseContext) GetEcosystemJan() v2.Jurisdiction {
	if x != nil {
		return x.EcosystemJan
	}
	return v2.Jurisdiction(0)
...
const file_platform_spec_v2_spec_proto_rawDesc = "" +
	...
	"\tspec_type\x18\x06 \x01(\tR\bspecType\x12G\n" +
	...
	"\tprincipal\x18\t \x01(\v2\x1f.platform.spec.v2.SpecPrincipalR\tprincipal\x12@\n" +
	"\fspan_context\x18\n" +
	" \x01(\v2\x1d.platform.spec.v2.SpanContextR\vspanContext\x127\n" +
	...
	"\n" +
	"spec_error\x18\x0f \x01(\v2\x12.google.rpc.StatusR\tspecError:\x06\xfa\xb6\x18\x02\b\x01\"\xed\x02\n" +
	"\n" +
	"SpecPublic\x12!\n" +
	"\fspec_version\x18\x01 \x01(\tR\vspecVersion\x12\x1d\n" +
	"\n" +
	...
	"receivedAt\x12=\n" +
	"\fcompleted_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\vcompletedAt\x12\x1b\n" +
	"\tspec_type\x18\x06 \x01(\tR\bspecType\x12\x1d\n" +
	"\n" +
	"spec_event\x18\b \x01(\tR\tspecEvent\x12(\n" +
	"\x04data\x18\t \x01(\v2\x14.google.protobuf.AnyR\x04data:\x06\xfa\xb6\x18\x02\b\x01\"\x80\x06\n" +
	"\vSpecContext\x12'\n" +
	"\x0forganization_id\x18\x01 \x01(\tR\x0eorganizationId\x12+\n" +
	"\x11organization_slug\x18\x02 \x01(\tR\x10organizationSlug\x12!\n" +
	"\fecosystem_id\x18\x03 \x01(\tR\vecosystemId\x12%\n" +
	"\x0eecosystem_slug\x18\x04 \x01(\tR\recosystemSlug\x12C\n" +
	"\recosystem_jan\x18\x05 \x01(\x0e2\x1e.platform.type.v2.JurisdictionR\fecosystemJan\x12N\n" +
	"\x0fprocedure_scope\x18\x06 \x01(\x0e2%.platform.options.v2.SpecRequestScopeR\x0eprocedureScope\x12\x0e\n" +
	"\x02ip\x18d \x01(\tR\x02ip\x12\x16\n" +
	"\x06locale\x18e \x01(\tR\x06locale\x12\x1a\n" +
	"\btimezone\x18f \x01(\tR\btimezone\x12\x1d\n" +
	"\n" +
	"user_agent\x18g \x01(\tR\tuserAgent\x12@\n" +
	"\n" +
	"validation\x18h \x01(\v2 .platform.spec.v2.SpecValidationR\n" +
	"validation\x12:\n" +
	"\bproducer\x18i \x01(\v2\x1e.platform.spec.v2.SpecProducerR\bproducer\x124\n" +
	"\x06device\x18j \x01(\v2\x1c.platform.spec.v2.SpecDeviceR\x06device\x12:\n" +
	"\blocation\x18k \x01(\v2\x1e.platform.spec.v2.SpecLocationR\blocation\x127\n" +
	"\anetwork\x18l \x01(\v2\x1d.platform.spec.v2.SpecNetworkR\anetwork\x12(\n" +
	"\x02os\x18m \x01(\v2\x18.platform.spec.v2.SpecOSR\x02os:\x06\xfa\xb6\x18\x02\b\x01\"\x90\x01\n" +
	...
	"\x05build\x18\x03 \x01(\tR\x05build\x12\x1c\n" +
	"\tnamespace\x18\x04 \x01(\tR\tnamespace:\x06\xfa\xb6\x18\x02\b\x01\"\xc3\x01\n" +
	"\n" +
	"SpecDevice\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12%\n" +
	"\x0eadvertising_id\x18\x03 \x01(\tR\radvertisingId\x12\"\n" +
	...
	"\x05token\x18\a \x01(\tR\x05token:\x06\xfa\xb6\x18\x02\b\x01\"\x94\x01\n" +
	"\fSpecLocation\x12\x12\n" +
	...
	"\x05speed\x18\x05 \x01(\tR\x05speed:\x06\xfa\xb6\x18\x02\b\x01\"}\n" +
	"\vSpecNetwork\x12\x1c\n" +
	"\tbluetooth\x18\x01 \x01(\bR\tbluetooth\x12\x1a\n" +
	"\bcellular\x18\x02 \x01(\bR\bcellular\x12\x12\n" +
	"\x04wifi\x18\x03 \x01(\bR\x04wifi\x12\x18\n" +
	"\acarrier\x18\x04 \x01(\tR\acarrier:\x06\xfa\xb6\x18\x02\b\x01\">\n" +
	"\x06SpecOS\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion:\x06\xfa\xb6\x18\x02\b\x01\"\xb3\x01\n" +
	"\bSpecData\x12:\n" +
	"\rconfiguration\x18\x01 \x01(\v2\x14.google.protobuf.AnyR\rconfiguration\x12(\n" +
	"\x04data\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\x04data\x129\n" +
	"\n" +
	"field_mask\x18\x03 \x01(\v2\x1a.google.protobuf.FieldMaskR\tfieldMask:\x06\xfa\xb6\x18\x02\b\x01\"\x98\x03\n" +
	"\x13SpecResponseContext\x12U\n" +
	"\x13response_validation\x18\x01 \x01(\v2$.platform.type.v2.ResponseValidationR\x12responseValidation\x12C\n" +
	"\rresponse_mask\x18\x02 \x01(\v2\x1e.platform.type.v2.ResponseMaskR\fresponseMask\x12%\n" +
	"\x0eecosystem_slug\x18\x03 \x01(\tR\recosystemSlug\x12+\n" +
	"\x11organization_slug\x182 \x01(\tR\x10organizationSlug\x12C\n" +
	"\recosystem_jan\x184 \x01(\x0e2\x1e.platform.type.v2.JurisdictionR\fecosystemJan\x12\x1d\n" +
	"\n" +
	"routine_id\x185 \x01(\tR\troutineId\x12%\n" +
	"\x0ecorrelation_id\x186 \x01(\tR\rcorrelationId:\x06\xfa\xb6\x18\x02\b\x02\"\r\n" +
...
var file_platform_spec_v2_spec_proto_depIdxs = []int32{
	...
	19, // 32: platform.spec.v2.SpecResponseContext.ecosystem_jan:type_name -> platform.type.v2.Jurisdiction
