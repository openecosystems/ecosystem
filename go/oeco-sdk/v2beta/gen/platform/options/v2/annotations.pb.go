...
const (
	...
	EntityHierarchy_ENTITY_HIERARCHY_ECOSYSTEM    EntityHierarchy = 3
)
...
const (
	...
	AuthRoleType_AUTH_ROLE_TYPE_ECOSYSTEM      AuthRoleType = 3
...
const (
	...
	AuthRole_AUTH_ROLE_ECOSYSTEM_SUPER_ADMIN       AuthRole = 300
	AuthRole_AUTH_ROLE_ECOSYSTEM_CLINICAL_ADMIN    AuthRole = 301
	AuthRole_AUTH_ROLE_ECOSYSTEM_BILLING_ADMIN     AuthRole = 302
	AuthRole_AUTH_ROLE_ECOSYSTEM_ADMIN             AuthRole = 303
	AuthRole_AUTH_ROLE_ECOSYSTEM_MANAGER           AuthRole = 304
	AuthRole_AUTH_ROLE_ECOSYSTEM_USER              AuthRole = 305
	AuthRole_AUTH_ROLE_ECOSYSTEM_VIEWER            AuthRole = 306
...
var (
	AuthRole_name = map[int32]string{
		...
		300: "AUTH_ROLE_ECOSYSTEM_SUPER_ADMIN",
		301: "AUTH_ROLE_ECOSYSTEM_CLINICAL_ADMIN",
		302: "AUTH_ROLE_ECOSYSTEM_BILLING_ADMIN",
		303: "AUTH_ROLE_ECOSYSTEM_ADMIN",
		304: "AUTH_ROLE_ECOSYSTEM_MANAGER",
		305: "AUTH_ROLE_ECOSYSTEM_USER",
		306: "AUTH_ROLE_ECOSYSTEM_VIEWER",
	...
	AuthRole_value = map[string]int32{
		...
		"AUTH_ROLE_ECOSYSTEM_SUPER_ADMIN":       300,
		"AUTH_ROLE_ECOSYSTEM_CLINICAL_ADMIN":    301,
		"AUTH_ROLE_ECOSYSTEM_BILLING_ADMIN":     302,
		"AUTH_ROLE_ECOSYSTEM_ADMIN":             303,
		"AUTH_ROLE_ECOSYSTEM_MANAGER":           304,
		"AUTH_ROLE_ECOSYSTEM_USER":              305,
		"AUTH_ROLE_ECOSYSTEM_VIEWER":            306,
...
const (
	...
	SpecRequestScope_SPEC_REQUEST_SCOPE_ANONYMOUS    SpecRequestScope = 1
	SpecRequestScope_SPEC_REQUEST_SCOPE_USER         SpecRequestScope = 2
	SpecRequestScope_SPEC_REQUEST_SCOPE_ECOSYSTEM    SpecRequestScope = 3
	SpecRequestScope_SPEC_REQUEST_SCOPE_ORGANIZATION SpecRequestScope = 4
	SpecRequestScope_SPEC_REQUEST_SCOPE_PLATFORM     SpecRequestScope = 5
)
...
var (
	SpecRequestScope_name = map[int32]string{
		...
		1: "SPEC_REQUEST_SCOPE_ANONYMOUS",
		2: "SPEC_REQUEST_SCOPE_USER",
		3: "SPEC_REQUEST_SCOPE_ECOSYSTEM",
		4: "SPEC_REQUEST_SCOPE_ORGANIZATION",
		5: "SPEC_REQUEST_SCOPE_PLATFORM",
	}
	SpecRequestScope_value = map[string]int32{
		"SPEC_REQUEST_SCOPE_UNSPECIFIED":  0,
		"SPEC_REQUEST_SCOPE_ANONYMOUS":    1,
		"SPEC_REQUEST_SCOPE_USER":         2,
		"SPEC_REQUEST_SCOPE_ECOSYSTEM":    3,
		"SPEC_REQUEST_SCOPE_ORGANIZATION": 4,
		"SPEC_REQUEST_SCOPE_PLATFORM":     5,
	}
)
...
type PermissionOptions struct {
	...
	Scope         SpecRequestScope       `protobuf:"varint,3,opt,name=scope,proto3,enum=platform.options.v2.SpecRequestScope" json:"scope,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PermissionOptions) GetScope() SpecRequestScope {
	if x != nil {
		return x.Scope
	}
...
func (x *SpecConfiguration) GetSecret() bool {
	if x != nil {
		return x.Secret
	}
	return false
...
const file_platform_options_v2_annotations_proto_rawDesc = "" +
	"\n" +
	...
	"\rSystemOptions\x12'\n" +
	"\x0fplatform_system\x18\x01 \x01(\bR\x0eplatformSystem\"\xb8\x02\n" +
	"\n" +
	"ApiOptions\x120\n" +
	...
	"\x04type\x18\x03 \x01(\x0e2\x1f.platform.options.v2.EntityTypeR\x04type\x12\x1c\n" +
	"\tnamespace\x18\x04 \x01(\tR\tnamespace\x12H\n" +
	"\vconsistency\x18\x05 \x01(\x0e2&.platform.options.v2.EntityConsistencyR\vconsistency\x12B\n" +
	"\thierarchy\x18\x06 \x01(\x0e2$.platform.options.v2.EntityHierarchyR\thierarchy\x12 \n" +
	"\vversionable\x18\a \x01(\bR\vversionable\"R\n" +
	"\x0fLanguageOptions\x12?\n" +
	"\tlanguages\x18\x01 \x03(\x0e2!.platform.options.v2.LanguageTypeR\tlanguages\"*\n" +
	"\x0eGraphqlOptions\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\"N\n" +
	"\x12SpecServiceOptions\x12\x1b\n" +
	"\tgrpc_port\x18\x01 \x01(\x05R\bgrpcPort\x12\x1b\n" +
	"\thttp_port\x18\x02 \x01(\x05R\bhttpPort\"C\n" +
	"\x0fRateLimitFilter\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12\x16\n" +
	"\x06metric\x18\x02 \x01(\tR\x06metric\"/\n" +
	"\x13AuthorizationFilter\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\")\n" +
	"\rConsentFilter\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\"\xe1\x01\n" +
	"\fProxyOptions\x12N\n" +
	"\rauthorization\x18\x01 \x01(\v2(.platform.options.v2.AuthorizationFilterR\rauthorization\x12<\n" +
	"\aconsent\x18\x02 \x01(\v2\".platform.options.v2.ConsentFilterR\aconsent\x12C\n" +
	"\n" +
	"rate_limit\x18\x03 \x01(\v2$.platform.options.v2.RateLimitFilterR\trateLimit\"J\n" +
	"\x10ConnectorOptions\x126\n" +
	"\x04type\x18\x01 \x01(\x0e2\".platform.options.v2.ConnectorTypeR\x04type\"@\n" +
	"\vCQRSOptions\x121\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1d.platform.options.v2.CQRSTypeR\x04type\"(\n" +
	"\x10RateLimitOptions\x12\x14\n" +
	"\x05limit\x18\x01 \x01(\bR\x05limit\"\xa5\x01\n" +
	"\x11PermissionOptions\x12\x1e\n" +
	"\n" +
	"permission\x18\x01 \x01(\tR\n" +
	"permission\x123\n" +
	"\x05roles\x18\x02 \x03(\x0e2\x1d.platform.options.v2.AuthRoleR\x05roles\x12;\n" +
	"\x05scope\x18\x03 \x01(\x0e2%.platform.options.v2.SpecRequestScopeR\x05scope\"B\n" +
	"\fGraphOptions\x122\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1e.platform.options.v2.GraphTypeR\x04type\"\x87\x01\n" +
	"\x12EntityFieldOptions\x12\x10\n" +
	"\x03key\x18\x01 \x01(\bR\x03key\x12>\n" +
	"\bbehavior\x18\x02 \x03(\x0e2\".platform.options.v2.FieldBehaviorR\bbehavior\x12\x1f\n" +
	"\vversion_key\x18\x03 \x01(\bR\n" +
	"versionKey\"\xdc\x03\n" +
	"\x11SpecConfiguration\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12P\n" +
	"\x04type\x18\x02 \x01(\x0e2<.platform.options.v2.SpecConfiguration.SpecConfigurationTypeR\x04type\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\"\n" +
	"\foverrideable\x18\x04 \x01(\bR\foverrideable\x12\x18\n" +
	"\aenabled\x18\x05 \x01(\bR\aenabled\x12\x16\n" +
	"\x06secret\x18\x06 \x01(\bR\x06secret\"\xea\x01\n" +
	"\x15SpecConfigurationType\x12'\n" +
	"#SPEC_CONFIGURATION_TYPE_UNSPECIFIED\x10\x00\x12\"\n" +
	"\x1eSPEC_CONFIGURATION_TYPE_STRING\x10\x01\x12 \n" +
	"\x1cSPEC_CONFIGURATION_TYPE_BOOL\x10\x02\x12\x1f\n" +
	"\x1bSPEC_CONFIGURATION_TYPE_INT\x10\x03\x12 \n" +
	"\x1cSPEC_CONFIGURATION_TYPE_LIST\x10\x04\x12\x1f\n" +
	"\x1bSPEC_CONFIGURATION_TYPE_MAP\x10\x05\"S\n" +
	"\x14ConfigurationOptions\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12!\n" +
	"\ffield_number\x18\x02 \x01(\x05R\vfieldNumber\"i\n" +
	"\x19ConfigurationFieldOptions\x12L\n" +
	"\rconfiguration\x18\x01 \x01(\v2&.platform.options.v2.SpecConfigurationR\rconfiguration\"q\n" +
	"\x10SyntheticOptions\x12%\n" +
	"\x0edictionary_key\x18\x01 \x01(\tR\rdictionaryKey\x126\n" +
	"\x04type\x18\x02 \x01(\x0e2\".platform.options.v2.SyntheticTypeR\x04type\"M\n" +
	"\x0eClassification\x12;\n" +
	"\x04type\x18\x01 \x01(\x0e2'.platform.options.v2.ClassificationTypeR\x04type\"D\n" +
	"\vSpecOptions\x125\n" +
	"\x04type\x18\x01 \x01(\x0e2!.platform.options.v2.SpecEnumTypeR\x04type\"q\n" +
	...
	"\trole_type\x18\x01 \x01(\x0e2!.platform.options.v2.AuthRoleTypeR\broleType\",\n" +
	"\x0eRoutineOptions\x12\x1a\n" +
	"\blistener\x18\x01 \x01(\tR\blistener*{\n" +
	"\vNetworkType\x12\x1c\n" +
	"\x18NETWORK_TYPE_UNSPECIFIED\x10\x00\x12\x19\n" +
	"\x15NETWORK_TYPE_UNDERLAY\x10\x01\x12\x19\n" +
	"\x15NETWORK_TYPE_INTERNET\x10\x02\x12\x18\n" +
	"\x14NETWORK_TYPE_OVERLAY\x10\x03*v\n" +
	"\aApiType\x12\x18\n" +
	"\x14API_TYPE_UNSPECIFIED\x10\x00\x12\x14\n" +
	"\x10API_TYPE_PRIVATE\x10\x01\x12\x14\n" +
	"\x10API_TYPE_PARTNER\x10\x02\x12\x13\n" +
	"\x0fAPI_TYPE_PUBLIC\x10\x03\x12\x10\n" +
	"\fAPI_TYPE_POC\x10\x04*\x87\x02\n" +
	"\x10ApiInterfaceType\x12\"\n" +
	"\x1eAPI_INTERFACE_TYPE_UNSPECIFIED\x10\x00\x12\x1b\n" +
	"\x17API_INTERFACE_TYPE_META\x10\x01\x12\"\n" +
	"\x1eAPI_INTERFACE_TYPE_OPERATIONAL\x10\x02\x12#\n" +
	"\x1fAPI_INTERFACE_TYPE_CONTRIBUTION\x10\x03\x12!\n" +
	"\x1dAPI_INTERFACE_TYPE_ANALYTICAL\x10\x04\x12!\n" +
	"\x1dAPI_INTERFACE_TYPE_OBSERVABLE\x10\x05\x12#\n" +
	"\x1fAPI_INTERFACE_TYPE_DISCOVERABLE\x10\x06*\xe7\x01\n" +
	"\fApiLifecycle\x12\x1d\n" +
	"\x19API_LIFECYCLE_UNSPECIFIED\x10\x00\x12\x17\n" +
	"\x13API_LIFECYCLE_ALPHA\x10\x01\x12\x16\n" +
	"\x12API_LIFECYCLE_BETA\x10\x02\x12&\n" +
	"\"API_LIFECYCLE_LIMITED_AVAILABILITY\x10\x03\x12&\n" +
	"\"API_LIFECYCLE_GENERAL_AVAILABILITY\x10\x04\x12\x1c\n" +
	"\x18API_LIFECYCLE_DEPRECATED\x10\x05\x12\x19\n" +
	"\x15API_LIFECYCLE_RETIRED\x10\x06*\xda\x01\n" +
	"\n" +
	"EntityType\x12\x1b\n" +
	"\x17ENTITY_TYPE_UNSPECIFIED\x10\x00\x12\x19\n" +
	"\x15ENTITY_TYPE_AEROSPIKE\x10\x01\x12\x16\n" +
	"\x12ENTITY_TYPE_DGRAPH\x10\x02\x12\x17\n" +
	"\x13ENTITY_TYPE_MONGODB\x10\x03\x12\x18\n" +
	"\x14ENTITY_TYPE_BIGQUERY\x10\x04\x12\x15\n" +
	"\x11ENTITY_TYPE_REDIS\x10\x05\x12\x17\n" +
	"\x13ENTITY_TYPE_ROCKSDB\x10\x06\x12\x19\n" +
	"\x15ENTITY_TYPE_COUCHBASE\x10\a*w\n" +
	"\x11EntityConsistency\x12\"\n" +
	"\x1eENTITY_CONSISTENCY_UNSPECIFIED\x10\x00\x12\x1d\n" +
	"\x19ENTITY_CONSISTENCY_STRONG\x10\x01\x12\x1f\n" +
	"\x1bENTITY_CONSISTENCY_EVENTUAL\x10\x02*\x95\x01\n" +
	"\x0fEntityHierarchy\x12 \n" +
	"\x1cENTITY_HIERARCHY_UNSPECIFIED\x10\x00\x12\x1d\n" +
	"\x19ENTITY_HIERARCHY_PLATFORM\x10\x01\x12!\n" +
	"\x1dENTITY_HIERARCHY_ORGANIZATION\x10\x02\x12\x1e\n" +
	"\x1aENTITY_HIERARCHY_ECOSYSTEM\x10\x03*\xcc\x02\n" +
	"\fLanguageType\x12\x1d\n" +
	"\x19LANGUAGE_TYPE_UNSPECIFIED\x10\x00\x12\x1b\n" +
	"\x17LANGUAGE_TYPE_CPLUSPLUS\x10\x01\x12\x16\n" +
	"\x12LANGUAGE_TYPE_RUST\x10\x02\x12\x18\n" +
	"\x14LANGUAGE_TYPE_GOLANG\x10\x03\x12\x16\n" +
	"\x12LANGUAGE_TYPE_JAVA\x10\x04\x12\x18\n" +
	"\x14LANGUAGE_TYPE_PYTHON\x10\x05\x12\x1c\n" +
	"\x18LANGUAGE_TYPE_TYPESCRIPT\x10\x06\x12\x18\n" +
	"\x14LANGUAGE_TYPE_CSHARP\x10\a\x12\x17\n" +
	"\x13LANGUAGE_TYPE_SWIFT\x10\b\x12\x19\n" +
	"\x15LANGUAGE_TYPE_ANDROID\x10\t\x12\x19\n" +
	"\x15LANGUAGE_TYPE_GRAPHQL\x10\n" +
	"\x12\x15\n" +
	"\x11LANGUAGE_TYPE_LUA\x10\v*M\n" +
	"\rConnectorType\x12\x1e\n" +
	"\x1aCONNECTOR_TYPE_UNSPECIFIED\x10\x00\x12\x1c\n" +
	"\x18CONNECTOR_TYPE_REFERENCE\x10\x01*\xad\x01\n" +
	"\fAuthRoleType\x12\x1e\n" +
	"\x1aAUTH_ROLE_TYPE_UNSPECIFIED\x10\x00\x12\x1b\n" +
	"\x17AUTH_ROLE_TYPE_PLATFORM\x10\x01\x12\x1f\n" +
	"\x1bAUTH_ROLE_TYPE_ORGANIZATION\x10\x02\x12\x1c\n" +
	"\x18AUTH_ROLE_TYPE_ECOSYSTEM\x10\x03\x12!\n" +
	"\x1dAUTH_ROLE_TYPE_CONNECTED_TEST\x10\x04*\xfa\x03\n" +
	"\bCQRSType\x12\x19\n" +
	"\x15CQRS_TYPE_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0eCQRS_TYPE_NONE\x10\x01\x12\x1d\n" +
	"\x19CQRS_TYPE_MUTATION_CREATE\x10\x02\x12\x1d\n" +
	"\x19CQRS_TYPE_MUTATION_UPDATE\x10\x03\x12\x1d\n" +
	"\x19CQRS_TYPE_MUTATION_DELETE\x10\x04\x12$\n" +
	" CQRS_TYPE_MUTATION_CLIENT_STREAM\x10\x05\x12$\n" +
	" CQRS_TYPE_MUTATION_SERVER_STREAM\x10\x06\x12\"\n" +
	"\x1eCQRS_TYPE_MUTATION_BIDI_STREAM\x10\a\x12\x18\n" +
	"\x14CQRS_TYPE_QUERY_LIST\x10\b\x12\x1a\n" +
	"\x16CQRS_TYPE_QUERY_STREAM\x10\t\x12\x17\n" +
	"\x13CQRS_TYPE_QUERY_GET\x10\n" +
	"\x12 \n" +
	"\x1cCQRS_TYPE_QUERY_EVENT_STREAM\x10\v\x12!\n" +
	...
	"\x18AUTH_ROLE_PLATFORM_ADMIN\x10g\x1a\x06\xf2\xb8\x18\x02\b\x01\x12&\n" +
	"\x1aAUTH_ROLE_PLATFORM_MANAGER\x10h\x1a\x06\xf2\xb8\x18\x02\b\x01\x12#\n" +
	"\x17AUTH_ROLE_PLATFORM_USER\x10i\x1a\x06\xf2\xb8\x18\x02\b\x01\x12%\n" +
	"\x19AUTH_ROLE_PLATFORM_VIEWER\x10j\x1a\x06\xf2\xb8\x18\x02\b\x01\x12/\n" +
	"\"AUTH_ROLE_ORGANIZATION_SUPER_ADMIN\x10\xc8\x01\x1a\x06\xf2\xb8\x18\x02\b\x02\x122\n" +
	"%AUTH_ROLE_ORGANIZATION_CLINICAL_ADMIN\x10\xc9\x01\x1a\x06\xf2\xb8\x18\x02\b\x02\x121\n" +
	"$AUTH_ROLE_ORGANIZATION_BILLING_ADMIN\x10\xca\x01\x1a\x06\xf2\xb8\x18\x02\b\x02\x12)\n" +
	"\x1cAUTH_ROLE_ORGANIZATION_ADMIN\x10\xcb\x01\x1a\x06\xf2\xb8\x18\x02\b\x02\x12+\n" +
	"\x1eAUTH_ROLE_ORGANIZATION_MANAGER\x10\xcc\x01\x1a\x06\xf2\xb8\x18\x02\b\x02\x12(\n" +
	"\x1bAUTH_ROLE_ORGANIZATION_USER\x10\xcd\x01\x1a\x06\xf2\xb8\x18\x02\b\x02\x12*\n" +
	"\x1dAUTH_ROLE_ORGANIZATION_VIEWER\x10\xce\x01\x1a\x06\xf2\xb8\x18\x02\b\x02\x12,\n" +
	"\x1fAUTH_ROLE_ECOSYSTEM_SUPER_ADMIN\x10\xac\x02\x1a\x06\xf2\xb8\x18\x02\b\x03\x12/\n" +
	"\"AUTH_ROLE_ECOSYSTEM_CLINICAL_ADMIN\x10\xad\x02\x1a\x06\xf2\xb8\x18\x02\b\x03\x12.\n" +
	"!AUTH_ROLE_ECOSYSTEM_BILLING_ADMIN\x10\xae\x02\x1a\x06\xf2\xb8\x18\x02\b\x03\x12&\n" +
	"\x19AUTH_ROLE_ECOSYSTEM_ADMIN\x10\xaf\x02\x1a\x06\xf2\xb8\x18\x02\b\x03\x12(\n" +
	"\x1bAUTH_ROLE_ECOSYSTEM_MANAGER\x10\xb0\x02\x1a\x06\xf2\xb8\x18\x02\b\x03\x12%\n" +
	"\x18AUTH_ROLE_ECOSYSTEM_USER\x10\xb1\x02\x1a\x06\xf2\xb8\x18\x02\b\x03\x12'\n" +
	"\x1aAUTH_ROLE_ECOSYSTEM_VIEWER\x10\xb2\x02\x1a\x06\xf2\xb8\x18\x02\b\x03\x12$\n" +
	" AUTH_ROLE_CONNECTED_TEST_PATIENT\x10\x0f\x12%\n" +
	"!AUTH_ROLE_CONNECTED_TEST_PROVIDER\x10\x10\x12\"\n" +
	"\x1eAUTH_ROLE_CONNECTED_TEST_PROXY\x10\x11\x12#\n" +
	"\x1fAUTH_ROLE_CONNECTED_TEST_VIEWER\x10\x12*T\n" +
	"\tGraphType\x12\x1a\n" +
	"\x16GRAPH_TYPE_UNSPECIFIED\x10\x00\x12\x14\n" +
	"\x10GRAPH_TYPE_INPUT\x10\x01\x12\x15\n" +
	"\x11GRAPH_TYPE_OUTPUT\x10\x02*\x8f\x02\n" +
	"\rFieldBehavior\x12\x1e\n" +
	"\x1aFIELD_BEHAVIOR_UNSPECIFIED\x10\x00\x12\x1b\n" +
	"\x17FIELD_BEHAVIOR_OPTIONAL\x10\x01\x12\x1b\n" +
	"\x17FIELD_BEHAVIOR_REQUIRED\x10\x02\x12\x1e\n" +
	"\x1aFIELD_BEHAVIOR_OUTPUT_ONLY\x10\x03\x12\x1d\n" +
	"\x19FIELD_BEHAVIOR_INPUT_ONLY\x10\x04\x12\x1c\n" +
	"\x18FIELD_BEHAVIOR_IMMUTABLE\x10\x05\x12!\n" +
	"\x1dFIELD_BEHAVIOR_UNORDERED_LIST\x10\x06\x12$\n" +
	" FIELD_BEHAVIOR_NON_EMPTY_DEFAULT\x10\a*\xcc\x01\n" +
	"\rSyntheticType\x12\x1e\n" +
	"\x1aSYNTHETIC_TYPE_UNSPECIFIED\x10\x00\x12)\n" +
	"%SYNTHETIC_TYPE_DIRECT_FROM_DICTIONARY\x10\x01\x12*\n" +
	"&SYNTHETIC_TYPE_SELECT_RANDOM_FROM_LIST\x10\x02\x12!\n" +
	"\x1dSYNTHETIC_TYPE_LIST_FROM_LIST\x10\x03\x12!\n" +
	"\x1dSYNTHETIC_TYPE_GENERATED_LOGO\x10\x06*\xc4\x02\n" +
	"\x12ClassificationType\x12#\n" +
	"\x1fCLASSIFICATION_TYPE_UNSPECIFIED\x10\x00\x12'\n" +
	"#CLASSIFICATION_TYPE_DERIVATIVE_DATA\x10\x01\x12%\n" +
	"!CLASSIFICATION_TYPE_DE_IDENTIFIED\x10\x02\x12\x1e\n" +
	"\x1aCLASSIFICATION_TYPE_PUBLIC\x10\x03\x12$\n" +
	" CLASSIFICATION_TYPE_INTERNAL_USE\x10\x04\x12$\n" +
	" CLASSIFICATION_TYPE_CONFIDENTIAL\x10\x05\x12\"\n" +
	"\x1eCLASSIFICATION_TYPE_RESTRICTED\x10\x06\x12)\n" +
	"%CLASSIFICATION_TYPE_HIGHLY_RESTRICTED\x10\a*\xc0\x01\n" +
	"\fSpecEnumType\x12\x1e\n" +
	"\x1aSPEC_ENUM_TYPE_UNSPECIFIED\x10\x00\x12\x17\n" +
	"\x13SPEC_ENUM_TYPE_NONE\x10\x01\x12\x19\n" +
	"\x15SPEC_ENUM_TYPE_TOPICS\x10\x02\x12\x1b\n" +
	"\x17SPEC_ENUM_TYPE_COMMANDS\x10\x03\x12\x19\n" +
	"\x15SPEC_ENUM_TYPE_EVENTS\x10\x04\x12$\n" +
	" SPEC_ENUM_TYPE_ROUTINE_LISTENERS\x10\x05*\xdd\x01\n" +
	"\x10SpecRequestScope\x12\"\n" +
	"\x1eSPEC_REQUEST_SCOPE_UNSPECIFIED\x10\x00\x12 \n" +
	"\x1cSPEC_REQUEST_SCOPE_ANONYMOUS\x10\x01\x12\x1b\n" +
	"\x17SPEC_REQUEST_SCOPE_USER\x10\x02\x12 \n" +
	"\x1cSPEC_REQUEST_SCOPE_ECOSYSTEM\x10\x03\x12#\n" +
	"\x1fSPEC_REQUEST_SCOPE_ORGANIZATION\x10\x04\x12\x1f\n" +
	"\x1bSPEC_REQUEST_SCOPE_PLATFORM\x10\x05:f\n" +
	...
	"\x05proxy\x12\x1f.google.protobuf.ServiceOptions\x18܆\x03 \x01(\v2!.platform.options.v2.ProxyOptionsR\x05proxy:f\n" +
	"\tconnector\x12\x1f.google.protobuf.ServiceOptions\x18݆\x03 \x01(\v2%.platform.options.v2.ConnectorOptionsR\tconnector:`\n" +
	"\n" +
	"api_method\x12\x1e.google.protobuf.MethodOptions\x18\xe4\x86\x03 \x01(\v2\x1f.platform.options.v2.ApiOptionsR\tapiMethod:V\n" +
	"\x04cqrs\x12\x1e.google.protobuf.MethodOptions\x18\xe5\x86\x03 \x01(\v2 .platform.options.v2.CQRSOptionsR\x04cqrs:h\n" +
	"\n" +
	"permission\x12\x1e.google.protobuf.MethodOptions\x18\xe6\x86\x03 \x01(\v2&.platform.options.v2.PermissionOptionsR\n" +
	"permission:[\n" +
	"\x04rate\x12\x1e.google.protobuf.MethodOptions\x18\xe7\x86\x03 \x01(\v2%.platform.options.v2.RateLimitOptionsR\x04rate:c\n" +
	"\vapi_message\x12\x1f.google.protobuf.MessageOptions\x18\xee\x86\x03 \x01(\v2\x1f.platform.options.v2.ApiOptionsR\n" +
	"apiMessage:Z\n" +
	"\x05graph\x12\x1f.google.protobuf.MessageOptions\x18\xef\x86\x03 \x01(\v2!.platform.options.v2.GraphOptionsR\x05graph:`\n" +
	"\aroutine\x12\x1f.google.protobuf.MessageOptions\x18\xf0\x86\x03 \x01(\v2#.platform.options.v2.RoutineOptionsR\aroutine:]\n" +
	"\tapi_field\x12\x1d.google.protobuf.FieldOptions\x18\xf8\x86\x03 \x01(\v2\x1f.platform.options.v2.ApiOptionsR\bapiField:k\n" +
	"\fentity_field\x12\x1d.google.protobuf.FieldOptions\x18\xf9\x86\x03 \x01(\v2'.platform.options.v2.EntityFieldOptionsR\ventityField:\x80\x01\n" +
	...
	"\x05event\x12!.google.protobuf.EnumValueOptions\x18\x8f\x87\x03 \x01(\v2!.platform.options.v2.EventOptionsR\x05eventB[ZYgithub.com/openecosystems/ecosystem/go/oeco-sdk/v2beta/gen/platform/options/v2;optionv2pbb\x06proto3"
...
var file_platform_options_v2_annotations_proto_depIdxs = []int32{
	...
	17, // 15: platform.options.v2.PermissionOptions.scope:type_name -> platform.options.v2.SpecRequestScope
